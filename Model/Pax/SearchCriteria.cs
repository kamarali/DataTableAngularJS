...
{
  /// <summary>
  /// Passenger Invoice Search Criteria. This is not an entity - so, does not derive from <see cref="EntityBase{PK}"/>.
  ...
  public class SearchCriteria
  {
    ...
    public int? InclusionStatus { get; set; }

    public DateTime? IsWebGenerationDate { get; set; }
