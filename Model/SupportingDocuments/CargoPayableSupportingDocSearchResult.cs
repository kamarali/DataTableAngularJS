...
{
    public class CargoPayableSupportingDocSearchResult : EntityBase<Guid>
  {
      ...
      public string CodeBilling { get; set; }
    ...
    public string SupportingDocTypeText
    {
      get
      {
        if (Type == SupportingDocType.MiscInvoice)
        {
    ...
    public string AttachmentIndValidatedText { get; set; }
    ...
    public CargoSupportingDocRecordType TypeofRecord
    {
      get
      {
          return (CargoSupportingDocRecordType)RecordType;
      }
    }
  }
}
