...
{
  public class BMCouponModelBinder : DefaultModelBinder
  {
    ...
    public override object BindModel(ControllerContext controllerContext, ModelBindingContext bindingContext)
    {
      ...
      var couponModel = model as BMCoupon;
      ...
      if (couponModel != null)
      {
        ...
        foreach (string code in taxCodes)
        {
          ...
          if (string.IsNullOrEmpty(id))
            continue;
          couponModel.TaxBreakdown.Add(new BMCouponTax()
          {
        ...
        foreach (string code in vatIds)
        {
          ...
          if (string.IsNullOrEmpty(id))
            continue;
          couponModel.VatBreakdown.Add(new BMCouponVat()
          {
        ...
        foreach (string code in attachmentIds)
        {
          ...
          if (string.IsNullOrEmpty(id))
            continue;
          couponModel.Attachments.Add(new BMCouponAttachment
          {
