...
{
  public interface IRejectionMemoRecordRepository : IRepository<CargoRejectionMemo>
  {
    /// <summary>
    /// Checks if rejection memo number already exists between a billing and billed member for the given billing period.
    /// </summary>
    ...
    /// <returns></returns>
    CgoRMLinkingResultDetails GetRMLinkingDetails(CgoRMLinkingCriteria criteria);
    ...
    CargoRejectionMemo Single(Guid? rejectionMemoId = null, Guid? correspondenceId = null);

    /// <summary>
    /// Inherits the RM AWB details.
    /// </summary>
    /// <param name="rejectionMemoId">The rejection memo id.</param>
    /// <returns></returns>
    string InheritRMAwbDetails(Guid rejectionMemoId);    
