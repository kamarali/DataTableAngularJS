...
namespace Iata.IS.Data.SupportingDocuments.Impl
{
  ...
  /// </summary>
    public class SupportingDocumentRepository : Repository<UnlinkedSupportingDocument>, ISupportingDocumentRepository
    {
      ...
      /// <returns></returns>
        public List<SupportingDocumentRecord> GetSupportingDocumentRecords(RecordSearchCriteria recordSearchCriteria)
        {
            ...
            parameters[1] = new ObjectParameter(SupportingDocumentsConstants.BillingMonth, typeof(int)) { Value = recordSearchCriteria.IsFormD ? recordSearchCriteria.FormDEBillingMonth : recordSearchCriteria.ClearanceMonth };
            parameters[2] = new ObjectParameter(SupportingDocumentsConstants.BillingPeriod, typeof(int)) { Value = recordSearchCriteria.IsFormD ? recordSearchCriteria.FormDEBillingPeriod : recordSearchCriteria.ClearancePeriod };
            ...
            parameters[10] = new ObjectParameter(SupportingDocumentsConstants.MismatchTransaction, typeof(int)) { Value = recordSearchCriteria.Mismatch };
        ...
        public string GetFormCFolderName(Guid formCDetailId, bool skipSuppDocLinkingDeadlineCheck)
        {
          var parameters = new ObjectParameter[3];

          parameters[0] = new ObjectParameter(SupportingDocumentsConstants.FormCDetailIdI, typeof(Guid)) { Value = formCDetailId };
          parameters[1] = new ObjectParameter(SupportingDocumentsConstants.SkipSuppDocLinkingDeadlineCheck, typeof (int)) {Value = skipSuppDocLinkingDeadlineCheck ? 1 : 0};
          parameters[2] = new ObjectParameter(SupportingDocumentsConstants.FolderNameO, typeof(string));

          ExecuteStoredProcedure(SupportingDocumentsConstants.GetFormCFolderName, parameters);
       ...
       // public IList<SupportingDocSearchCriteria> GetCargoSupportingDocumentSearchResult(SupportingDocSearchCriteria criteria)
        { 
            ...
            parameters[5] = new ObjectParameter(SupportingDocumentsConstants.InvoiceTypeParameterName, typeof(int)) { Value = criteria.SupportingDocumentTypeId };
            parameters[6] = new ObjectParameter(SupportingDocumentsConstants.InvoiceNoParameterName, typeof(string)) { Value = criteria.InvoiceNumber };
            parameters[7] = new ObjectParameter(SupportingDocumentsConstants.BillingCodeParameterName, typeof(int)) { Value = criteria.BillingCode };
            parameters[8] = new ObjectParameter(SupportingDocumentsConstants.BatchNoParameterName, typeof(int?)) { Value = criteria.BatchSequenceNumber };

            parameters[9] = new ObjectParameter(SupportingDocumentsConstants.SequenceNoParameterName, typeof(int?)) { Value = criteria.RecordSequenceWithinBatch };
            parameters[10] = new ObjectParameter(SupportingDocumentsConstants.RMBMCMNumberParameterName, typeof(string)) { Value = criteria.RMBMCMNumber };

            parameters[11] = new ObjectParameter(SupportingDocumentsConstants.AWBSerialNumberParameterName, typeof(int)) { Value = criteria.AWBSerialNumber };
           // parameters[12] = new ObjectParameter(SupportingDocumentsConstants.CouponNoParameterName, typeof(int?)) { Value = criteria.CouponNumber };
        ...
        public IList<PayableSupportingDocSearchResult> GetCargoPayableSupportingDocumentSearchResult(SupportingDocSearchCriteria criteria)
        {
            ...
            parameters[3] = new ObjectParameter(SupportingDocumentsConstants.CgoPayableBillingMemberIdParameterName, typeof(int)) { Value = criteria.BillingMemberId };
            parameters[4] = new ObjectParameter(SupportingDocumentsConstants.CgoPayableBilledMemberIdParameterName, typeof(int)) { Value = criteria.BilledMemberId };
            ...
            parameters[10] = new ObjectParameter(SupportingDocumentsConstants.CgoPayableBillingCodeParameterName, typeof(int?)) { Value = criteria.DisplayBillingCode };
            ...
            parameters[12] = new ObjectParameter(SupportingDocumentsConstants.CgoPayableAttachmentIndOriginParameterName, typeof(int)) { Value = criteria.AttachmentIndicatorOriginal };
            
            var searchResult = ExecuteStoredFunction<PayableSupportingDocSearchResult>(SupportingDocumentsConstants.GetCargoPayableSupportingDocumentSearchResultFunctionName, parameters);
