...
namespace Iata.IS.Web.Util.ModelBinders.Cargo
{
  ...
  public class InvoiceModelBinder : DefaultModelBinder
  {
    public override object BindModel(ControllerContext controllerContext, ModelBindingContext bindingContext)
    {
      ...
      var invoiceModel = model as CargoInvoice;
    ...
    private static void GetBillingMemberLocationInfo(NameValueCollection form, CargoInvoice invoice)
    {
    ...
    /// <param name="form"></param>
    /// <param name="invoice"></param>
    private static void GetBilledMemberLocationInfo(NameValueCollection form, CargoInvoice invoice)
    {
