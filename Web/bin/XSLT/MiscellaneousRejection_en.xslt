        ...
        <fo:table-body>
          <fo:table-row height="20mm">
            ...
            <fo:table-cell xsl:use-attribute-sets="pageTitle" number-rows-spanned="2">
              <fo:block>Miscellaneous Rejection Invoice</fo:block>
            </fo:table-cell>
                                  ...
                                  <fo:block padding-before="1mm" padding-after="4mm">
                                    <fo:table table-layout="fixed" width="100%" inline-progression-dimension="auto">
                                      ...
                                      <fo:table-body>
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabel" text-align="end">Original Invoice #</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabel" text-align="end">Original Settlement Month Period</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
      ...
      <xsl:if test="(count(//MiscellaneousRejectionLineItems/MiscellaneousRejectionLineItem) > 0) 
        ...
        <fo:table-header>
          <fo:table-row height="5.8mm" background-color="#3E90CD">
            ...
            <fo:table-cell xsl:use-attribute-sets="tableColumnLabel alignVCenter alignCenter">
              <fo:block>Original Line #</fo:block>
            </fo:table-cell>
            ...
            <fo:table-cell xsl:use-attribute-sets="tableColumnLabel alignVCenter">
              <fo:block>Rej. Reason Code</fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="tableColumnLabel alignVCenter">
    ...
    <fo:table table-layout="fixed" width="100%" xsl:use-attribute-sets="borderB">
      ...
      <fo:table-header>
        ...
        <fo:table-row height="5.8mm" background-color="#3E90CD">
          ...
          <fo:table-cell  xsl:use-attribute-sets="tableColumnLabel alignVCenter borderR">
            <fo:block>Legend of Rejection Reason Codes used in Line Items</fo:block>
          </fo:table-cell>
        </fo:table-row>
      </fo:table-header>
      <fo:table-body>
