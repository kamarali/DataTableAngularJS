...
<xsl:stylesheet
        ...
        <fo:table-body>
          <fo:table-row height="20mm">
            ...
            <fo:table-cell xsl:use-attribute-sets="pageTitle" number-rows-spanned="2">
              <fo:block>Nota de crédito Miscellaneous</fo:block>
            </fo:table-cell>
                                  ...
                                  <fo:block padding-before="1mm" padding-after="4mm">
                                    <fo:table table-layout="fixed" width="100%" inline-progression-dimension="auto">
                                      ...
                                      <fo:table-body>
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabel" text-align="end">Número de nota de crédito</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabel" text-align="end">Método de facturación</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabel" text-align="end">Lugar donde el servicio fue prestado</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabel" text-align="end">Código del transmisor</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabel" text-align="end">Nombre del transmisor</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
        ...
        <fo:table-body>
          <fo:table-row>
            <fo:table-cell>
              ...
              <xsl:if test="(count(/InvoiceTemplate/MiscellaneousCreditNoteLineItems/MiscellaneousCreditNoteLineItem) > 0) 
                      or (count(/InvoiceTemplate/MiscellaneousCreditNoteLineItems/SubTotal) > 0)
  ...
  <xsl:template name="LineItems">
    <fo:table table-layout="fixed" width="100%" xsl:use-attribute-sets="borderB">
      ...
      <xsl:if test="(count(/InvoiceTemplate/MiscellaneousCreditNoteLineItems/MiscellaneousCreditNoteLineItem) > 0) 
        ...
        <fo:table-header>
          <fo:table-row height="5.8mm" background-color="#3E90CD">
            ...
            <fo:table-cell xsl:use-attribute-sets="tableColumnLabel alignVCenter">
              <fo:block>Lugar donde el servicio fue prestado</fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="tableColumnLabel alignVCenter">
      ...
      <fo:table-body>
        <xsl:choose>
          <xsl:when test="//MiscellaneousCreditNoteLineItems/MiscellaneousCreditNoteLineItem">
            <xsl:for-each select="/InvoiceTemplate/MiscellaneousCreditNoteLineItems/MiscellaneousCreditNoteLineItem">
        ...
        <xsl:if test="count(/InvoiceTemplate/MiscellaneousCreditNoteLineItems/SubTotal) > 0">
          <fo:table-row>
            ...
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight borderT" padding-right="2mm">
              <fo:block padding-before="5mm">
                <xsl:value-of select="/InvoiceTemplate/MiscellaneousCreditNoteLineItems/SubTotal/BaseAmount"/>
              </fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight borderT" padding-right="2mm">
              <fo:block padding-before="5mm">
                <xsl:value-of select="/InvoiceTemplate/MiscellaneousCreditNoteLineItems/SubTotal/AdditionalAmount"/>
              </fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight borderT" padding-right="2mm">
              <fo:block padding-before="5mm">
                <xsl:value-of select="/InvoiceTemplate/MiscellaneousCreditNoteLineItems/SubTotal/Tax"/>
              </fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight borderT" padding-right="2mm">
              <fo:block padding-before="5mm">
                <xsl:value-of select="/InvoiceTemplate/MiscellaneousCreditNoteLineItems/SubTotal/Vat"/>
              </fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight borderT borderR" padding-right="2mm">
              ...
              <fo:block padding-before="5mm">
                    <xsl:value-of select="/InvoiceTemplate/MiscellaneousCreditNoteLineItems/SubTotal/LineAmount"/>
              </fo:block>
              -->
              <fo:block/>
            </fo:table-cell>
        ...
        <xsl:if test="count(/InvoiceTemplate/MiscellaneousCreditNoteLineItems/HeaderSubTotal) > 0">
          <fo:table-row>
            ...
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight" padding-right="2mm">
              <fo:block padding-before="1mm">
                <xsl:value-of select="/InvoiceTemplate/MiscellaneousCreditNoteLineItems/HeaderSubTotal/AdditionalAmount"/>
              </fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight" padding-right="2mm">
              <fo:block padding-before="1mm">
                <xsl:value-of select="/InvoiceTemplate/MiscellaneousCreditNoteLineItems/HeaderSubTotal/Tax"/>
              </fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight" padding-right="2mm">
              <fo:block padding-before="1mm">
                <xsl:value-of select="/InvoiceTemplate/MiscellaneousCreditNoteLineItems/HeaderSubTotal/Vat"/>
              </fo:block>
            </fo:table-cell>
          ...
          <xsl:when test="//InvoiceSummary/VatBreakDown/VatItem">
            <xsl:for-each select="/InvoiceTemplate/InvoiceSummary/VatBreakDown/VatItem">
              <fo:table-row height="4mm">
                ...
                <fo:table-cell xsl:use-attribute-sets="fieldData">
                  <fo:block>
