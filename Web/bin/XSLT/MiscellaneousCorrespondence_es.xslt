        ...
        <fo:table-body>
          <fo:table-row height="20mm">
            ...
            <fo:table-cell xsl:use-attribute-sets="pageTitle" number-rows-spanned="2">
              <fo:block>Factura Miscellaneous</fo:block>
            </fo:table-cell>
                                  ...
                                  <fo:block padding-before="1mm" padding-after="4mm">
                                    <fo:table table-layout="fixed" width="100%" inline-progression-dimension="auto">
                                      ...
                                      <fo:table-body>
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabel" text-align="end">Número de factura de rechazo</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabel" text-align="end">Número de correspondencia</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
