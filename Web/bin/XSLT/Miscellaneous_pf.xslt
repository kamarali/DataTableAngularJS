...
<xsl:stylesheet
    ...
    <fo:root>
      <fo:layout-master-set>
        ...
        <fo:simple-page-master master-name="first-page-layout" page-height="210mm" page-width="297mm" margin-left="5mm" margin-right="5mm" margin-top="5mm" margin-bottom="5mm">
          <!--no use over here,<fo:region-before region-name="header" />-->
          <!-- extent="35mm" -->
        ...
        <fo:simple-page-master
          ...
          margin-top="5mm"
          margin-bottom="5mm">
          <fo:region-before region-name="header-partial" extent="35.7mm"/>
          <!-- CMP#649:Changes-->
          <fo:region-body region-name="body" margin-top="34.8mm">
            <xsl:attribute name="margin-bottom">
              <xsl:choose>
                <xsl:when test="count(/InvoiceTemplate/InvoiceFooter/LegalText) > 0">
                  14mm
  ...
  <xsl:template name="header-first">
    ...
    <!-- this is use to draw border for header <fo:block-container  top="19.7mm" height="100%">-->
    <!--position="absolute"-->
    <!--<fo:block >-->
    <!--position="absolute"-->
    ...
    <!--<fo:table-column column-width="95mm"/>
            ...
            <fo:table-body>
              <fo:table-row height="75mm">
                <fo:table-cell xsl:use-attribute-sets="borderL borderB borderT" />
        ...
        <fo:table-body>
          <fo:table-row height="20mm">
            ...
            <fo:table-cell xsl:use-attribute-sets="pageTitle" number-rows-spanned="2">
              <fo:block>Miscellaneous Proforma Invoice</fo:block>
            </fo:table-cell>
                    ...
                    <fo:table-row>
                      <fo:table-cell>
                        <fo:block>
                          <fo:table table-layout="fixed" width="100%" >
                            <!-- inline-progression-dimension="auto" -->
                            <fo:table-column xsl:use-attribute-sets="borderL borderB borderT" column-width="95mm"/>
                            <fo:table-column xsl:use-attribute-sets="borderT borderB" column-width="proportional-column-width(1)"/>
                            <!--xsl:use-attribute-sets="borderT borderB borderT borderB" -->
                            <fo:table-column xsl:use-attribute-sets="borderR borderT borderB" column-width="95mm"/>
                            <fo:table-body>
                              <fo:table-row>
                                <fo:table-cell>
                                  <fo:block padding-before="1mm" padding-after="1mm">
                                    <!--padding-before="1mm" padding-after="4mm"-->
                                    <fo:table table-layout="fixed" width="100%" >
                                      <!-- inline-progression-dimension="auto" -->
                                      <fo:table-column/>
                                      ...
                                      <fo:table-body>
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Billing Entity Name</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <!--SCP#481602 - Original invoice (PDF) + SCP#481263 +SCP#481923 - Urgent matter (CMP#649 Aligment issues)-->
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                              <!--<xsl:value-of select="/InvoiceTemplate/InvoiceHeader/BillingEntity/EntityName"/>-->
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceHeader/BillingEntity/EntityName"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Entity Designator &amp; Num.Code</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData" margin="0mm">
                                              ...
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="concat(/InvoiceTemplate/InvoiceHeader/BillingEntity/EntityDesignator, '-', /InvoiceTemplate/InvoiceHeader/BillingEntity/EntityNumericCode)"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                            </fo:block>
                                          </fo:table-cell>
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Location ID</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Contact Person</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                              <!--<xsl:value-of select="/InvoiceTemplate/InvoiceHeader/BillingEntity/ContactPerson"/>-->
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceHeader/BillingEntity/ContactPerson"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                            </fo:block>
                                          </fo:table-cell>
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Street</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                              <!--<xsl:value-of select="/InvoiceTemplate/InvoiceHeader/BillingEntity/Location/AddressLine1"/>-->
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceHeader/BillingEntity/Location/AddressLine1"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                            </fo:block>
                                          </fo:table-cell>
                                          ...
                                          <fo:table-row line-height="10pt">
                                            <fo:table-cell column-number="3">
                                              <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                                ...
                                                <xsl:call-template name="text_wrapper">
                                                  <xsl:with-param name="Text" select="concat(/InvoiceTemplate/InvoiceHeader/BillingEntity/Location/AddressLine2, '&#160;')"/>
                                                  <xsl:with-param name="TextLen" select="number(26)"/>
                                                </xsl:call-template>
                                              </fo:block>
                                            </fo:table-cell>
                                          ...
                                          <fo:table-row  line-height="10pt">
                                            <fo:table-cell column-number="3">
                                              <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                                ...
                                                <xsl:call-template name="text_wrapper">
                                                  <xsl:with-param name="Text" select="concat(/InvoiceTemplate/InvoiceHeader/BillingEntity/Location/AddressLine3, '&#160;')"/>
                                                  <xsl:with-param name="TextLen" select="number(26)"/>
                                                </xsl:call-template>
                                              </fo:block>
                                            </fo:table-cell>
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">City</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                              <!--<xsl:value-of select="/InvoiceTemplate/InvoiceHeader/BillingEntity/Location/City"/>-->
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceHeader/BillingEntity/Location/City"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                            </fo:block>
                                          </fo:table-cell>
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">State/Region</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                              <!--<xsl:value-of select="/InvoiceTemplate/InvoiceHeader/BillingEntity/Location/Region"/>-->
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceHeader/BillingEntity/Location/Region"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                            </fo:block>
                                          </fo:table-cell>
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Zip/Postal Code</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                              <!--<xsl:value-of select="/InvoiceTemplate/InvoiceHeader/BillingEntity/Location/PostalCode"/>-->
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceHeader/BillingEntity/Location/PostalCode"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                            </fo:block>
                                          </fo:table-cell>
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Country</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                              <!--<xsl:value-of select="/InvoiceTemplate/InvoiceHeader/BillingEntity/Location/Country"/>-->
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceHeader/BillingEntity/Location/Country"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                            </fo:block>
                                          </fo:table-cell>
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Tax/VAT Registration #</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                              <!--<xsl:value-of select="/InvoiceTemplate/InvoiceHeader/BillingEntity/TaxRegistrationNumber"/>-->
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceHeader/BillingEntity/TaxRegistrationNumber"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                            </fo:block>
                                          </fo:table-cell>
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Company Registration #</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                              <!--<xsl:value-of select="/InvoiceTemplate/InvoiceHeader/BillingEntity/CompanyRegistrationNumber"/>-->
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceHeader/BillingEntity/CompanyRegistrationNumber"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                        <!-- Empty Row added for space between header and header note-->
                                  ...
                                  <fo:block >
                                    ...
                                    <fo:table table-layout="fixed" width="100%" >
                                      ...
                                      <fo:table-body>
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Invoice #</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Date</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Month/Year</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Period</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Tax Invoice Number</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Charge Category</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Currency of Billing</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
                                        ...
                                        <xsl:if test="/InvoiceTemplate/InvoiceSummary/ClearanceCurrencyCode !=''">
                                          <fo:table-row line-height="10pt">
                                            <fo:table-cell>
                                              <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Currency of Clearance</fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell column-number="3">
                                              <fo:block xsl:use-attribute-sets="fieldData">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Settlement Method</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">PO Number</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Location Code</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Transmitter Code</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Transmitter Name</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Attachments</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
                                        ...
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Line Item Details</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData">
                                        ...
                                        <xsl:if test="/InvoiceTemplate/InvoiceHeader/CHAgreementIndicator !=''">
                                          <!--<xsl:if test="count(/InvoiceTemplate/InvoiceHeader/CHAgreementIndicator) > 0">-->
                                          <fo:table-row line-height="10pt">
                                            <fo:table-cell>
                                              <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">CH Agreement Indicator</fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell column-number="3">
                                              <fo:block xsl:use-attribute-sets="fieldData">
                                        ...
                                        <xsl:if test="/InvoiceTemplate/InvoiceHeader/CHDueDate !=''">
                                          <!--<xsl:if test="count(/InvoiceTemplate/InvoiceHeader/CHDueDate) > 0">-->
                                          <fo:table-row line-height="10pt">
                                            <fo:table-cell>
                                              <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">CH Due Date</fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell column-number="3">
                                              <fo:block xsl:use-attribute-sets="fieldData">
                                  ...
                                  <fo:block padding-before="1mm" padding-after="1mm">
                                    ...
                                    <fo:table table-layout="fixed" width="100%" >
                                      ...
                                      <fo:table-body>
                                        <fo:table-row line-height="10pt">
                                          <fo:table-cell>
                                            <fo:block xsl:use-attribute-sets="fieldLabelBold" text-align="end">Billed Entity Name</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell column-number="3">
                                            <!--SCP#481602 - Original invoice (PDF) + SCP#481263 +SCP#481923 - Urgent matter (CMP#649 Aligment issues)-->
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                              ...
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceHeader/BilledEntity/EntityName"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                            </fo:block>
                                          </fo:table-cell>
                                        ...
                                        <fo:table-row line-height="10pt">
                                          ...
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                              ...
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="concat(/InvoiceTemplate/InvoiceHeader/BilledEntity/EntityDesignator, '-', /InvoiceTemplate/InvoiceHeader/BilledEntity/EntityNumericCode)"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                            </fo:block>
                                          </fo:table-cell>
                                        ...
                                        <fo:table-row line-height="10pt">
                                          ...
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                              ...
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceHeader/BilledEntity/ContactPerson"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                            </fo:block>
                                          </fo:table-cell>
                                        ...
                                        <fo:table-row line-height="10pt">
                                          ...
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                              ...
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceHeader/BilledEntity/Location/AddressLine1"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                            </fo:block>
                                          </fo:table-cell>
                                          ...
                                          <fo:table-row  line-height="10pt">
                                            <fo:table-cell column-number="3">
                                              <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                                ...
                                                <xsl:call-template name="text_wrapper">
                                                  <xsl:with-param name="Text" select="concat(/InvoiceTemplate/InvoiceHeader/BilledEntity/Location/AddressLine2, '&#160;')"/>
                                                  <xsl:with-param name="TextLen" select="number(26)"/>
                                                </xsl:call-template>
                                              </fo:block>
                                            </fo:table-cell>
                                          ...
                                          <fo:table-row  line-height="10pt">
                                            <fo:table-cell column-number="3">
                                              <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                                ...
                                                <xsl:call-template name="text_wrapper">
                                                  <xsl:with-param name="Text" select="concat(/InvoiceTemplate/InvoiceHeader/BilledEntity/Location/AddressLine3, '&#160;')"/>
                                                  <xsl:with-param name="TextLen" select="number(26)"/>
                                                </xsl:call-template>
                                              </fo:block>
                                            </fo:table-cell>
                                        ...
                                        <fo:table-row line-height="10pt">
                                          ...
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                              ...
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceHeader/BilledEntity/Location/City"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                            </fo:block>
                                          </fo:table-cell>
                                        ...
                                        <fo:table-row line-height="10pt">
                                          ...
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                              ...
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceHeader/BilledEntity/Location/Region"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                            </fo:block>
                                          </fo:table-cell>
                                        ...
                                        <fo:table-row line-height="10pt">
                                          ...
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                              ...
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceHeader/BilledEntity/Location/PostalCode"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                            </fo:block>
                                          </fo:table-cell>
                                        ...
                                        <fo:table-row line-height="10pt">
                                          ...
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                              ...
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceHeader/BilledEntity/Location/Country"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                            </fo:block>
                                          </fo:table-cell>
                                        ...
                                        <fo:table-row line-height="10pt">
                                          ...
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                              ...
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceHeader/BilledEntity/TaxRegistrationNumber"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                              <xsl:text>&#160;</xsl:text>
                                            </fo:block>
                                        ...
                                        <fo:table-row line-height="10pt">
                                          ...
                                          <fo:table-cell column-number="3">
                                            <fo:block xsl:use-attribute-sets="fieldData" margin-right="0mm">
                                              ...
                                              <xsl:call-template name="text_wrapper">
                                                <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceHeader/BilledEntity/CompanyRegistrationNumber"/>
                                                <xsl:with-param name="TextLen" select="number(26)"/>
                                              </xsl:call-template>
                                            </fo:block>
                                          </fo:table-cell>
              ...
              <fo:table-cell>
                <fo:block>
                  <fo:table table-layout="fixed" width="100%" inline-progression-dimension="auto">
                    ...
                    <fo:table-column column-width="95mm"/>
                    <fo:table-body>
                      <fo:table-row height="15.5mm">
                        <fo:table-cell  height="15.5mm" xsl:use-attribute-sets="borderL borderT borderB"/>
                        <fo:table-cell  height="15.5mm" xsl:use-attribute-sets="headerCenterColumn borderB borderT"/>
                        <fo:table-cell  height="15.5mm" xsl:use-attribute-sets="borderR borderT borderB"/>
                      </fo:table-row>
                    </fo:table-body>
                  </fo:table>
                </fo:block>
          ...
          <fo:table-row>
            <fo:table-cell>
              ...
              <xsl:if test="(count(/InvoiceTemplate/InvoiceHeader/HeaderNotes/Note) > 0)">
                <xsl:call-template name="HeaderNote"/>
              </xsl:if>
              <!--CMP#649 End-->
                  ...
                  <fo:table-body>
                    ...
                    <fo:table-row height="2mm">
                      ...
                      <fo:table-cell padding-top ="1mm">
                        <fo:block  margin-left="1mm" xsl:use-attribute-sets="fieldData">
                          <xsl:variable name="FullInvoiceData">
                            <xsl:for-each select="/InvoiceTemplate/InvoiceHeader/HeaderNotes/InvoiceData">
                              <xsl:value-of select="concat(., ' ; ')"/>
                            </xsl:for-each>
                          </xsl:variable>
                          <xsl:call-template name="String_wrapper">
                            <xsl:with-param name="Text" select="$FullInvoiceData"/>
                            <xsl:with-param name="TextLen" select="number(163)"/>
                            <xsl:with-param name="LbTxt" select="concat('Invoice', ' Data: ')"/>
                          </xsl:call-template>
                        </fo:block>
                      </fo:table-cell>
                    </fo:table-row>
  ...
  <!--CMP#649Header Note Details -->
  <!--SCP#481602 - Original invoice (PDF) + SCP#481263 +SCP#481923 - Urgent matter (CMP#649 Aligment issues)-->
  <xsl:template name="HeaderNote">
    <fo:table table-layout="fixed" width="100%" >
      <fo:table-column column-width="proportional-column-width(1)"/>
      <fo:table-body>
        <xsl:if test="count(/InvoiceTemplate/InvoiceHeader/HeaderNotes/Note) > 0">
                ...
                <fo:table table-layout="fixed" width="100%" inline-progression-dimension="auto">
                  ...
                  <fo:table-body>
                    ...
                    <fo:table-row height="2mm">
                      ...
                      <fo:table-cell padding-top ="1mm">
                        <fo:block margin-left="1mm" xsl:use-attribute-sets="fieldData">
                          <xsl:variable name="FullHeaderNote">
                            <xsl:for-each select="/InvoiceTemplate/InvoiceHeader/HeaderNotes/Note">
                              <xsl:value-of select="concat(., ' ')"/>
                            </xsl:for-each>
                          </xsl:variable>
                          <xsl:call-template name="String_wrapper">
                            <xsl:with-param name="Text" select="$FullHeaderNote"/>
                            <xsl:with-param name="TextLen" select="number(163)"/>
                            <xsl:with-param name="LbTxt" select="concat('Header', ' Notes: ')"/>
                          </xsl:call-template>
                        </fo:block>
                      </fo:table-cell>
                    </fo:table-row>
  ...
  <xsl:template name="LineItems">
    <fo:table padding-top ="0.3mm" table-layout="fixed" width="100%" xsl:use-attribute-sets="borderB">
      ...
      <xsl:if test="(count(//MiscellaneousLineItems/MiscellaneousLineItem) > 0) 
        ...
        <fo:table-header>
          <fo:table-row height="5.8mm" background-color="#3E90CD">
            ...
            <fo:table-cell xsl:use-attribute-sets="tableColumnLabel alignVCenter alignCenter" padding-right="0.5mm">
            ...
            <fo:table-cell xsl:use-attribute-sets="tableColumnLabel alignVCenter alignCenter" padding-right="0.5mm">
              <fo:block>Base</fo:block>
              <fo:block>Amount</fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="tableColumnLabel alignVCenter alignCenter">
              <fo:block>Additional Amount</fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="tableColumnLabel alignVCenter alignCenter" padding-left="7mm">
              <fo:block>Tax</fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="tableColumnLabel alignVCenter alignCenter" padding-left="7mm">
              <fo:block>VAT</fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="tableColumnLabel alignVCenter alignCenter borderR" padding-right="0.5mm">
      ...
      <fo:table-body>
              ...
              <fo:table-row>
                      ...
                      <xsl:otherwise>
                        <xsl:choose>
                          <xsl:when test="($DateOfServiceBegin != '')">
                            ...
                            <xsl:call-template name="text_wrapper">
                              <xsl:with-param name="Text" select="$DateOfServiceBegin"/>
                              <xsl:with-param name="TextLen" select="number(13)"/>
                            </xsl:call-template>
                          </xsl:when>
                          <xsl:otherwise>
                            <!-- <xsl:value-of select="$DateOfServiceEnd" />-->
                            <xsl:call-template name="text_wrapper">
                              <xsl:with-param name="Text" select="$DateOfServiceEnd"/>
                              <xsl:with-param name="TextLen" select="number(13)"/>
                            </xsl:call-template>
                          </xsl:otherwise>
                        </xsl:choose>
                ...
                <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter paddingTB">
                  <xsl:if test="(ChargeCodeType ='')">
                    <fo:block>
                      ...
                      <xsl:call-template name="text_wrapper">
                        <xsl:with-param name="Text" select="ChargeCode"/>
                        <xsl:with-param name="TextLen" select="number(9)"/>
                      </xsl:call-template>
                    </fo:block>
                  </xsl:if>
                  <xsl:if test="(ChargeCodeType !='')">
                    <fo:block>
                      <!-- <xsl:value-of select="concat(ChargeCode, ' - ', ChargeCodeType)"/>-->
                      <xsl:call-template name="text_wrapper">
                        <xsl:with-param name="Text" select="concat(ChargeCode, ' - ', ChargeCodeType)"/>
                        <xsl:with-param name="TextLen" select="number(9)"/>
                      </xsl:call-template>
                    </fo:block>
                  </xsl:if>
                ...
                <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter paddingTB">
                  <fo:block>
                    ...
                    <xsl:call-template name="text_wrapper">
                      <xsl:with-param name="Text" select="ProductID"/>
                      <xsl:with-param name="TextLen" select="number(19)"/>
                    </xsl:call-template>
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter paddingTB">
                  <fo:block>
                    ...
                    <xsl:call-template name="text_wrapper">
                      ...
                      <xsl:with-param name="TextLen" select="number(21)"/>
                    </xsl:call-template>
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter alignRight paddingTB" padding-right="2mm">
                  <fo:block>
                    ...
                    <xsl:call-template name="text_wrapper">
                      <xsl:with-param name="Text" select="Quantity"/>
                      <xsl:with-param name="TextLen" select="number(9)"/>
                    </xsl:call-template>
                  </fo:block>
                </fo:table-cell>
                ...
                <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter alignRight paddingTB" padding-right="0.5mm">
                  <fo:block>
                    <!--<xsl:value-of select="UnitPrice"/>-->
                    <xsl:call-template name="text_wrapper">
                      <xsl:with-param name="Text" select="UnitPrice"/>
                      <xsl:with-param name="TextLen" select="number(10)"/>
                    </xsl:call-template>
                ...
                <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter alignRight paddingTB" padding-right="0.5mm">
                  <fo:block>
                    ...
                    <xsl:call-template name="text_wrapper">
                      <xsl:with-param name="Text" select="BaseAmount"/>
                      <xsl:with-param name="TextLen" select="number(10)"/>
                    </xsl:call-template>
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter alignRight paddingTB" padding-right="0.5mm">
                  <fo:block>
                    ...
                    <xsl:call-template name="text_wrapper">
                      <xsl:with-param name="Text" select="AdditionalAmount"/>
                      <xsl:with-param name="TextLen" select="number(10)"/>
                    </xsl:call-template>
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter alignRight paddingTB" padding-right="0.5mm">
                  <fo:block>
                    ...
                    <xsl:call-template name="text_wrapper">
                      <xsl:with-param name="Text" select="Tax"/>
                      <xsl:with-param name="TextLen" select="number(10)"/>
                    </xsl:call-template>
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter alignRight paddingTB" padding-right="0.5mm">
                  <fo:block>
                    ...
                    <xsl:call-template name="text_wrapper">
                      <xsl:with-param name="Text" select="Vat"/>
                      <xsl:with-param name="TextLen" select="number(10)"/>
                    </xsl:call-template>
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter alignRight paddingTB borderR" padding-right="0.5mm">
                  <fo:block>
                    <!--<xsl:value-of select="LineAmount"/>-->
                    <xsl:call-template name="text_wrapper">
                      <xsl:with-param name="Text" select="LineAmount"/>
                      <xsl:with-param name="TextLen" select="number(10)"/>
                    </xsl:call-template>
                  </fo:block>
                </fo:table-cell>
        ...
        <xsl:if test="count(/InvoiceTemplate/MiscellaneousLineItems/SubTotal) > 0">
          <fo:table-row>
            ...
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight borderT" padding-right="0.5mm">
              <fo:block padding-before="5mm">
                <!--<xsl:value-of select="/InvoiceTemplate/MiscellaneousLineItems/SubTotal/BaseAmount"/>-->
                <xsl:call-template name="text_wrapper">
                  <xsl:with-param name="Text" select="/InvoiceTemplate/MiscellaneousLineItems/SubTotal/BaseAmount"/>
                  <xsl:with-param name="TextLen" select="number(10)"/>
                </xsl:call-template>
              </fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight borderT" padding-right="0.5mm">
              <fo:block padding-before="5mm">
                ...
                <xsl:call-template name="text_wrapper">
                  <xsl:with-param name="Text" select="/InvoiceTemplate/MiscellaneousLineItems/SubTotal/AdditionalAmount"/>
                  <xsl:with-param name="TextLen" select="number(10)"/>
                </xsl:call-template>
              </fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight borderT" padding-right="0.5mm">
              <fo:block padding-before="5mm">
                ...
                <xsl:call-template name="text_wrapper">
                  <xsl:with-param name="Text" select="/InvoiceTemplate/MiscellaneousLineItems/SubTotal/Tax"/>
                  <xsl:with-param name="TextLen" select="number(10)"/>
                </xsl:call-template>
              </fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight borderT" padding-right="0.5mm">
              <fo:block padding-before="5mm">
                ...
                <xsl:call-template name="text_wrapper">
                  <xsl:with-param name="Text" select="/InvoiceTemplate/MiscellaneousLineItems/SubTotal/Vat"/>
                  <xsl:with-param name="TextLen" select="number(10)"/>
                </xsl:call-template>
              </fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight borderT borderR" padding-right="0.5mm">
        ...
        <xsl:if test="count(/InvoiceTemplate/MiscellaneousLineItems/HeaderSubTotal) > 0">
          <fo:table-row>
            ...
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight" padding-right="0.5mm">
              <fo:block/>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight" padding-right="0.5mm">
              <fo:block padding-before="1mm">
                ...
                <xsl:call-template name="text_wrapper">
                  <xsl:with-param name="Text" select="/InvoiceTemplate/MiscellaneousLineItems/HeaderSubTotal/AdditionalAmount"/>
                  <xsl:with-param name="TextLen" select="number(10)"/>
                </xsl:call-template>
              </fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight" padding-right="0.5mm">
              <fo:block padding-before="1mm">
                ...
                <xsl:call-template name="text_wrapper">
                  <xsl:with-param name="Text" select="/InvoiceTemplate/MiscellaneousLineItems/HeaderSubTotal/Tax"/>
                  <xsl:with-param name="TextLen" select="number(10)"/>
                </xsl:call-template>
              </fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight" padding-right="0.5mm">
              <fo:block padding-before="1mm">
                ...
                <xsl:call-template name="text_wrapper">
                  <xsl:with-param name="Text" select="/InvoiceTemplate/MiscellaneousLineItems/HeaderSubTotal/Vat"/>
                  <xsl:with-param name="TextLen" select="number(10)"/>
                </xsl:call-template>
              </fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight borderR" padding-right="0.5mm">
              <fo:block padding-before="1mm"/>
            </fo:table-cell>
          </fo:table-row>
        </xsl:if>
        <xsl:if test="count(InvoiceTemplate/InvoiceSummary/SubTotals) > 0">
          <fo:table-row keep-with-next="always" line-height="10pt">
            ...
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight borderR" column-number="14" padding-right="0.5mm">
              <fo:block>
                <!--<xsl:value-of select="/InvoiceTemplate/InvoiceSummary/SubTotals/TotalInvoiceBaseAmount"/>-->
                <xsl:call-template name="text_wrapper">
                  <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceSummary/SubTotals/TotalInvoiceBaseAmount"/>
                  <xsl:with-param name="TextLen" select="number(10)"/>
                </xsl:call-template>
              </fo:block>
            </fo:table-cell>
          ...
          <fo:table-row keep-with-next="always" line-height="10pt">
            ...
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight borderR" column-number="14" padding-right="0.5mm">
              <fo:block>
                ...
                <xsl:call-template name="text_wrapper">
                  <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceSummary/SubTotals/TotalInvoiceAdditionalAmount"/>
                  <xsl:with-param name="TextLen" select="number(10)"/>
                </xsl:call-template>
              </fo:block>
            </fo:table-cell>
          ...
          <fo:table-row keep-with-next="always" line-height="10pt">
            ...
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight borderR" column-number="14" padding-right="0.5mm">
              <fo:block>
                ...
                <xsl:call-template name="text_wrapper">
                  <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceSummary/SubTotals/TotalInvoiceTaxAmount"/>
                  <xsl:with-param name="TextLen" select="number(10)"/>
                </xsl:call-template>
              </fo:block>
            </fo:table-cell>
          ...
          <fo:table-row keep-with-next="always" line-height="10pt">
            <fo:table-cell xsl:use-attribute-sets="borderL"/>
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight" column-number="8" number-columns-spanned="2">
              <fo:block wrap-option="no-wrap">Total Invoice VAT Amount&#160;</fo:block>
            </fo:table-cell>
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight borderR" column-number="14" padding-right="0.5mm">
              <fo:block>
                <!--<xsl:value-of select="/InvoiceTemplate/InvoiceSummary/SubTotals/TotalInvoiceVATAmount"/>-->
                <xsl:call-template name="text_wrapper">
                  <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceSummary/SubTotals/TotalInvoiceVATAmount"/>
                  <xsl:with-param name="TextLen" select="number(10)"/>
                </xsl:call-template>
              </fo:block>
            </fo:table-cell>
          ...
          <fo:table-row keep-with-next="always" line-height="10pt">
            ...
            <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight borderR" padding-right="0.5mm">
              <fo:block>
                ...
                <xsl:call-template name="text_wrapper">
                  <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceSummary/SubTotals/TotalDueInCurrencyOfBilling/Amount"/>
                  <xsl:with-param name="TextLen" select="number(10)"/>
                </xsl:call-template>
              </fo:block>
            </fo:table-cell>
            ...
            <fo:table-row keep-with-next="always" line-height="10pt">
              ...
              <fo:table-cell xsl:use-attribute-sets="fieldDataBold alignVCenter alignRight borderR" padding-right="0.5mm">
                <fo:block padding-after="5mm">
                  ...
                  <xsl:call-template name="text_wrapper">
                    <xsl:with-param name="Text" select="/InvoiceTemplate/InvoiceSummary/TotalAmountDueInCurrencyOfClearance"/>
                    <xsl:with-param name="TextLen" select="number(10)"/>
                  </xsl:call-template>
                </fo:block>
              </fo:table-cell>
              ...
              <fo:table-row height="4mm">
                ...
                <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter">
                  <fo:block wrap-option="wrap">
                    ...
                    <xsl:call-template name="text_wrapper">
                      <xsl:with-param name="Text" select="VatText"/>
                      <xsl:with-param name="TextLen" select="number(45)"/>
                    </xsl:call-template>
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter alignRight" padding-right="10mm">
                  <fo:block>
  ...
  <xsl:template name="AmtBreakDown">
    <fo:table table-layout="fixed" width="100%" xsl:use-attribute-sets="borderB">
      ...
      <fo:table-header>
        <fo:table-row height="5.8mm" background-color="#3E90CD">
          <fo:table-cell xsl:use-attribute-sets="tableColumnLabel alignVCenter borderL" padding-left="10mm">
            <fo:block>Additional Amount Breakdown</fo:block>
          </fo:table-cell>
          <fo:table-cell xsl:use-attribute-sets="tableColumnLabel alignVCenter">
            <fo:block>Level</fo:block>
          </fo:table-cell>
              ...
              <fo:table-row height="4mm">
                ...
                <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter">
                  <fo:block>
                    ...
                    <xsl:call-template name="text_wrapper">
                      <xsl:with-param name="Text" select="AdditionalAmountName"/>
                      <xsl:with-param name="TextLen" select="number(45)"/>
                    </xsl:call-template>
                  </fo:block>
                </fo:table-cell>
                <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter alignRight" padding-right="10mm">
                  <fo:block>
                    ...
                    <xsl:call-template name="text_wrapper">
                      <xsl:with-param name="Text" select="ChargeableAmount"/>
                      <xsl:with-param name="TextLen" select="number(10)"/>
                    </xsl:call-template>
                  </fo:block>
                </fo:table-cell>
  ...
  <!-- CMP#649:Change Text Wrapping and alignment changes-->
                            ...
                            <fo:table-row height="4mm">
                              <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter borderL" padding-left="10mm">
                                <fo:block>
                                  ...
                                  <xsl:call-template name="text_wrapper">
                                    <xsl:with-param name="Text" select="Description"/>
                                    <xsl:with-param name="TextLen" select="number(35)"/>
                                  </xsl:call-template>
                                </fo:block>
                              </fo:table-cell>
                              ...
                              <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter alignCenter">
                                <fo:block>
                                  ...
                                  <xsl:call-template name="text_wrapper">
                                    <xsl:with-param name="Text" select="Terms"/>
                                    <xsl:with-param name="TextLen" select="number(15)"/>
                                  </xsl:call-template>
                                </fo:block>
                              </fo:table-cell>
                              <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter alignCenter">
                                <fo:block>
                                  ...
                                  <xsl:call-template name="text_wrapper">
                                    <xsl:with-param name="Text" select="BankName"/>
                                    <xsl:with-param name="TextLen" select="number(29)"/>
                                  </xsl:call-template>
                                </fo:block>
                              </fo:table-cell>
                              <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter alignCenter">
                                <fo:block>
                                  ...
                                  <xsl:call-template name="text_wrapper">
                                    <xsl:with-param name="Text" select="ContactPerson"/>
                                    <xsl:with-param name="TextLen" select="number(15)"/>
                                  </xsl:call-template>
                                </fo:block>
                              </fo:table-cell>
                              <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter alignCenter">
                                <fo:block>
                                  ...
                                  <xsl:call-template name="text_wrapper">
                                    <xsl:with-param name="Text" select="BankCode"/>
                                    <xsl:with-param name="TextLen" select="number(20)"/>
                                  </xsl:call-template>
                                </fo:block>
                              </fo:table-cell>
                              <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter alignCenter borderR">
                                <fo:block>
                                  ...
                                  <xsl:call-template name="text_wrapper">
                                    <xsl:with-param name="Text" select="BranchCode"/>
                                    <xsl:with-param name="TextLen" select="number(20)"/>
                                  </xsl:call-template>
                                </fo:block>
                              </fo:table-cell>
                            ...
                            <fo:table-row height="4mm">
                              <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter alignCenter borderL" padding-left="10mm">
                                <fo:block>
                                  ...
                                  <xsl:call-template name="text_wrapper">
                                    ...
                                    <xsl:with-param name="TextLen" select="number(52)"/>
                                  </xsl:call-template>
                                </fo:block>
                              </fo:table-cell>
                              <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter alignCenter">
                              ...
                              <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter alignCenter">
                                <fo:block>
                                  ...
                                  <xsl:call-template name="text_wrapper">
                                    <xsl:with-param name="Text" select="BankAccountNumber"/>
                                    <xsl:with-param name="TextLen" select="number(49)"/>
                                  </xsl:call-template>
                                </fo:block>
                              </fo:table-cell>
                              <fo:table-cell xsl:use-attribute-sets="fieldData alignVCenter alignCenter">
  ...
  <xsl:template name="show-footer-text">
    <xsl:if test="count(/InvoiceTemplate/InvoiceFooter/LegalText) > 0">
      <fo:block padding-before="2mm" xsl:use-attribute-sets="LegalTxtData">
        <xsl:variable name="FullLegalText">
          <xsl:for-each select="/InvoiceTemplate/InvoiceFooter/LegalText">
            <xsl:value-of select="concat(., '')"/>
          </xsl:for-each>
        </xsl:variable>
        <xsl:call-template name="text_wrapper">
          <xsl:with-param name="Text" select="$FullLegalText"/>
          <xsl:with-param name="TextLen" select="number(246)"/>
        </xsl:call-template>
      </fo:block>
    </xsl:if>
    <fo:block padding-top="1mm" xsl:use-attribute-sets="LegalTxtData">
  ...
  <xsl:template name="text_wrapper">
    <xsl:param name="Text"/>
    <xsl:param name="TextLen"/>
    <xsl:choose>
      <xsl:when test="string-length($Text)">
        <xsl:value-of select="substring($Text,1,number($TextLen))"/>
        <xsl:text>&#10;</xsl:text>
        <xsl:call-template name="wrapper_helper">
          <xsl:with-param name="Text" select="substring($Text,$TextLen+1)"/>
          <xsl:with-param name="TextLen" select="$TextLen"/>
        </xsl:call-template>
      </xsl:when>
    </xsl:choose>
  </xsl:template>
  ...
  <!-- CMP#649:New Warpping Function-->
  <xsl:template name="String_wrapper">
    <xsl:param name="Text"/>
    <xsl:param name="TextLen"/>
    <xsl:param name="LbTxt"/>
    <xsl:choose>
      <xsl:when test="string-length($Text)">
        <xsl:if test="$LbTxt !='0'">
          <fo:inline xsl:use-attribute-sets="fieldLabel">
            <xsl:value-of select="$LbTxt"/>
          </fo:inline>
        </xsl:if>
        <xsl:value-of select="substring($Text,1,number($TextLen)- string-length($LbTxt))"/>
        <xsl:text>&#10;</xsl:text>
        <xsl:call-template name="text_wrapper">
          <xsl:with-param name="Text" select="substring($Text,$TextLen - string-length($LbTxt)+1)"/>
          <xsl:with-param name="TextLen" select="$TextLen"/>
        </xsl:call-template>
      </xsl:when>
    </xsl:choose>
  </xsl:template>
  <xsl:template name="StringWarp_helper">
    <xsl:param name="Text"/>
    <xsl:param name="TextLen"/>
    <xsl:param name="LbTxt"/>
    <xsl:value-of select="substring($Text,1,number($TextLen))"/>
    ...
    <xsl:call-template name="String_wrapper">
      <xsl:with-param name="Text" select="substring($Text,$TextLen+1)"/>
      <xsl:with-param name="TextLen" select="$TextLen"/>
      <xsl:with-param name="LbTxt" select="$LbTxt"/>
    </xsl:call-template>
  </xsl:template>
  <!-- CMP#649:Change Font Name-->
  ...
  <xsl:attribute-set name="LegalTxtData">
    <xsl:attribute name="font-family">Consolas</xsl:attribute>
  ...
  <xsl:attribute-set name="headerCenterColumn">
    <xsl:attribute name="border-left">#3E90CD 0.4pt solid</xsl:attribute>
    <xsl:attribute name="border-right">#3E90CD 0.4pt solid</xsl:attribute>
