namespace Iata.IS.Web.Reports.ProcessingDashBoard
{
  public class RechargeDataReport
  {
    ...
    public string MembershipSubStatus { get; set; }
    ...
    public int PAXVDeterminationRequests { get; set; }
    ...
    public long TotalSizeEArchivingPAX { get; set; }
    public long TotalSizeEArchivingCGO { get; set; }
    public long TotalSizeEArchivingMISC { get; set; }
    public long TotalSizeEArchivingUATP { get; set; }
    ...
    //CMP605 : Inclusion of new fields in Usage report and IATA recharge XML file.
    public int PAXInvoicesPayable { get; set; }
    public int CGOInvoicesPayable { get; set; }
    public int MISCInvoicesPayable { get; set; }
    public int UATPInvoicesPayable { get; set; }
