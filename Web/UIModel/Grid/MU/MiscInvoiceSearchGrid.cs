...
namespace Iata.IS.Web.UIModel.Grid.MU
{
  ...
  {
    public MiscInvoiceSearchGrid(string gridId, string dataUrl) : base(gridId, dataUrl)
    {
    }
    ...
    protected override void InitializeColumns()
    {
      if (_grid != null)
      {
        _grid.Columns = new List<JQGridColumn>
                          {
                            ...
                            GridColumnHelper.TextColumn("BillingMemLocationCode", "Billing Member’s Location ID", 100, true), // CMP #655: IS-WEB Display per Location ID
        ...
        _grid.Columns[18].Formatter = exchangeRateNullFormatter;
        var clearanceAmountNullFormatter = new CustomFormatter { FormatFunction = "clearanceAmountNullFormatter" };
        _grid.Columns[20].Formatter = clearanceAmountNullFormatter;
