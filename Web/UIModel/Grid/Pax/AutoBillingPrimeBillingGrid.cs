...
{
  /// <summary>
  /// UIModel for AutoBilling Prime Billing list
  /// </summary>
  public class AutoBillingPrimeBillingGrid : GridBase
  {
    public AutoBillingPrimeBillingGrid(string gridId, string dataUrl, bool isCheckBoxRequired = false)
    ...
    protected override void InitializeColumns()
    {
      if (_grid != null)
      {
        ...
        _grid.SortSettings.InitialSortColumn = "RecordSequenceWithinBatch";
