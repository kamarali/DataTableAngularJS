...
{
    /// <summary>
    /// UIModel for AWB Prepaid Billing list
    /// </summary>
    public class AwbPrepaidBillingGrid : GridBase
    {
        public AwbPrepaidBillingGrid(string gridId, string dataUrl, bool isCheckBoxRequired = false)
        ...
        protected override void InitializeColumns()
        {
            if (_grid != null)
            {
                ...
                _grid.Columns.Find(column => column.DataField == "WeightCharges").Formatter = new CustomFormatter { FormatFunction = "DisplayNullableAmountFormatter" };
                _grid.Columns.Find(column => column.DataField == "ValuationCharges").Formatter = new CustomFormatter { FormatFunction = "DisplayNullableAmountFormatter" };
                _grid.Columns.Find(column => column.DataField == "BilledWeight").Formatter = new CustomFormatter { FormatFunction = "SetBilledWeight" };
