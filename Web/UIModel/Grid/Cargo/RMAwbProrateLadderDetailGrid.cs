...
{
    public class RMAwbProrateLadderDetailGrid: GridBase
    {
        public RMAwbProrateLadderDetailGrid(string gridId, string dataUrl)
            : base(gridId, dataUrl)
        {
        }
                ...
                _grid.Columns = new List<JQGridColumn>
                                {
                                    ...
                                    GridColumnHelper.SortableTextColumn("ProvisoReqSpa", "Proviso Req Spa", 90),
                                    GridColumnHelper.SortableTextColumn("ProrateFactor", "Prorate Factor", 90),
                                    GridColumnHelper.SortableTextColumn("PercentShare", "Percent Share", 90),
