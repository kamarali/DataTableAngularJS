...
{
  public class CargoBMOtherChargeGrid : GridBase
  {
      public CargoBMOtherChargeGrid(string gridId, string dataUrl, bool isGridViewOnly = false)
      ...
      _grid.Columns = new List<JQGridColumn>
                        {
                          ...
                          GridColumnHelper.TextColumn("OtherChargeCodeValue","Other Charge Code Value",70),
