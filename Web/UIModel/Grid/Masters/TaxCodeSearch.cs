...
{
    public class TaxCodeSearch : GridBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaxCodeSearch"/> class.
        /// </summary>
        /// <param name="gridId">The grid id.</param>
        /// <param name="dataUrl">The data URL.</param>
        public TaxCodeSearch(string gridId, string dataUrl)
            : base(gridId, dataUrl)
        {
        }
                ...
                _grid.Columns = new List<JQGridColumn>
                                    {
                                        ...
                                        GridColumnHelper.SortableTextColumn("Id", "Tax Code", 80),
                                        GridColumnHelper.SortableTextColumn("TaxCodeTypeId", "Tax Code Type", 115),
