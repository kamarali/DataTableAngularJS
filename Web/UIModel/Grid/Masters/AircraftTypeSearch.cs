...
{
    public class AircraftTypeSearch : GridBase
    {
        ...
        public AircraftTypeSearch(string gridId, string dataUrl)
      : base(gridId, dataUrl)
    {
    }
                ...
                _grid.Columns = new List<JQGridColumn>
                                    {
                                        ...
                                        GridColumnHelper.SortableTextColumn("Id", "Aircraft Type Code", 150),
