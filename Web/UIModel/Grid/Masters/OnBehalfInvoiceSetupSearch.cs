...
{
    public class OnBehalfInvoiceSetupSearch : GridBase
    {
        /// <summary>
        ...
        public OnBehalfInvoiceSetupSearch(string gridId, string dataUrl)
            : base(gridId, dataUrl)
        {
        }
                ...
                _grid.Columns = new List<JQGridColumn>
                                    {
                                        ...
                                        GridColumnHelper.HiddenColumn("IsActive"),
                                         GridColumnHelper.SortableTextColumn("BillingCategory", "Billing Category", 115),
                                        GridColumnHelper.SortableTextColumn("TransmitterCode", "Transmitter Code", 130),
                                        GridColumnHelper.SortableTextColumn("ChargeCategoryName", "Charge Category", 130),
                                        GridColumnHelper.SortableTextColumn("ChargeCodeName", "Charge Code", 115),
