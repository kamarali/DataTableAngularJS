...
{
    public class AircraftTypeIcaoSearch : GridBase
    {
        /// <summary>
        ...
        public AircraftTypeIcaoSearch(string gridId, string dataUrl)
            : base(gridId, dataUrl)
        {
        }
                ...
                _grid.Columns = new List<JQGridColumn>
                                    {
                                        ...
                                        GridColumnHelper.SortableTextColumn("Id", "Aircraft Type ICAO Code", 200),
