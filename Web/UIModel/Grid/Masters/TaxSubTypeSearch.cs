...
{
    public class TaxSubTypeSearch : GridBase
    {
        /// <summary>
        ...
        public TaxSubTypeSearch(string gridId, string dataUrl)
            : base(gridId, dataUrl)
        {
        }
                ...
                _grid.Columns = new List<JQGridColumn>
                                    {
                                        ...
                                        GridColumnHelper.SortableTextColumn("SubType", "Tax Sub Type", 300),
                                        GridColumnHelper.SortableTextColumn("Type", "Tax Type", 200),
