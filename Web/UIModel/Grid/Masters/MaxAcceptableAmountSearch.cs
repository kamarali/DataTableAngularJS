...
{
    public class MaxAcceptableAmountSearch : GridBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaxAcceptableAmountSearch"/> class.
        /// </summary>
        /// <param name="gridId">The grid id.</param>
        /// <param name="dataUrl">The data URL.</param>
        public MaxAcceptableAmountSearch(string gridId, string dataUrl)
            : base(gridId, dataUrl)
        {
        }
        /// <summary>
                ...
                _grid.Columns = new List<JQGridColumn>
                                    {
                                        ...
                                        GridColumnHelper.SortableTextColumn("Amount", "Amount", 80),
