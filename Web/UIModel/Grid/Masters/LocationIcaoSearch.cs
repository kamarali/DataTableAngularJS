...
{
    public class LocationIcaoSearch : GridBase
    {
        /// <summary>
        ...
        public LocationIcaoSearch(string gridId, string dataUrl)
            : base(gridId, dataUrl)
        {
        }
                ...
                _grid.Columns = new List<JQGridColumn>
                                    {
                                        ...
                                        GridColumnHelper.SortableTextColumn("Id", "Location ICAO Code", 150),
