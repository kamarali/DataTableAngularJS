...
{
    public class ChargeCategorySearch : GridBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChargeCategorySearch"/> class.
        /// </summary>
        /// <param name="gridId">The grid id.</param>
        /// <param name="dataUrl">The data URL.</param>
        public ChargeCategorySearch(string gridId, string dataUrl)
            : base(gridId, dataUrl)
        {
        }
                ...
                _grid.Columns = new List<JQGridColumn>
                                    {
                                        ...
                                        GridColumnHelper.SortableTextColumn("Name", "Charge Category Name", 300),
                                        GridColumnHelper.TextColumn("Description", "Description", 150),
