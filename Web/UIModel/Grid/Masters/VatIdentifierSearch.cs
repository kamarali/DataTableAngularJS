...
{
    public class VatIdentifierSearch : GridBase
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="VatIdentifierSearch"/> class.
        /// </summary>
        /// <param name="gridId">The grid id.</param>
        /// <param name="dataUrl">The data URL.</param>
        public VatIdentifierSearch(string gridId, string dataUrl)
            : base(gridId, dataUrl)
        {
        }
                ...
                _grid.Columns = new List<JQGridColumn>
                                    {
                                        ...
                                        GridColumnHelper.SortableTextColumn("Identifier", "Identifier", 80),
