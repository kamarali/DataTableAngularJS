...
{
    public class CountrySearch : GridBase
    {
        /// <summary>
        ...
        public CountrySearch(string gridId, string dataUrl)
      : base(gridId, dataUrl)
    {
    }
                ...
                _grid.Columns = new List<JQGridColumn>
                                    {
                                        ...
                                        GridColumnHelper.SortableTextColumn("Id", "Country Code", 100),
                                        GridColumnHelper.SortableTextColumn("Name", "Country Name", 150),
                                        GridColumnHelper.SortableTextColumn("DsFormat", "Legal Format for Digital Signature",150),
                                        GridColumnHelper.SortableTextColumn("DsSupportedByAtos", "Digital Signature Supported?",150),
