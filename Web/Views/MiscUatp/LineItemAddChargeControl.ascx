<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<List<Iata.IS.Model.MiscUatp.LineItemAddOnCharge>>" %>
<%@ Import Namespace="Iata.IS.Model.MiscUatp" %>
<form id="formAddChargeDetails" method="get" action=""> 
<div>
  <% Html.RenderPartial("~/Views/MiscUatp/LineItemAddChargeDetailsControl.ascx", new LineItemAddOnCharge());%>
</div>
