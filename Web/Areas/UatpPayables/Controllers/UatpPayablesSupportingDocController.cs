...
using Iata.IS.Business.Security.Permissions.UATP.Payables;
...
{
    public class UatpPayablesSupportingDocController : MiscUatpControllerBase
    {
      ...
      public UatpPayablesSupportingDocController(IUatpInvoiceManager uatpInvoiceManager, IReferenceManager referenceManger, IMemberManager memberManager, ISupportingDocumentManager supportingDocumentManager)
          : base(uatpInvoiceManager, referenceManger, memberManager)
      {
      ...
      public ActionResult PayableSupportingDocs()
      {
        ...
        var searchResultGrid = new PayableSupportingDocSearchResultGrid(ControlIdConstants.SupportingDocSearchResultGrid, Url.Action(PayableSupportingDocSearchGridAction, "UatpPayablesSupportingDoc"),false);
        ViewData[ViewDataConstants.SupportingDocSearchResultGrid] = searchResultGrid.Instance;

        var attachmentGrid = new PayableSupportingAttachmentGrid(ControlIdConstants.AttachmentGrid, Url.Action("AttachmentGridData", "UatpPayablesSupportingDoc", new { }));
      ...
      public ActionResult PayableSupportingDocs(SupportingDocSearchCriteria searchCriteria)
      {
        ...
        var searchResultGrid = new PayableSupportingDocSearchResultGrid(ControlIdConstants.SupportingDocSearchResultGrid, Url.Action(PayableSupportingDocSearchGridAction, "UatpPayablesSupportingDoc", new { criteria }), false);
        ViewData[ViewDataConstants.SupportingDocSearchResultGrid] = searchResultGrid.Instance;
      ...
      {
          var suppDocResultGrid = new PayableSupportingDocSearchResultGrid(ControlIdConstants.SupportingDocSearchResultGrid, Url.Action(PayableSupportingDocSearchGridAction, "UatpPayablesSupportingDoc",
                                                                                  new
                                                                                  {
                                                                                    criteria
                                                                                  }), false);
      ...
      {
          var attachmentGrid = new PayableSupportingAttachmentGrid(ControlIdConstants.AttachmentGrid, Url.Action("AttachmentGridData", "UatpPayablesSupportingDoc", new { invoiceId }));
