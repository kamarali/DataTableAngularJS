...
<div class="buttonContainer">
    ...
    <% if (Model.LineItemDetail.Id != Model.LineItemDetail.NavigationDetails.FirstId)
       {%>
    <input class="secondaryButton" value="First" onclick="javascript:location.href='<%: Url.Action(actionToRedirect, "MiscPayCreditNote", new { invoiceId = Model.LineItemDetail.LineItem.InvoiceId, lineItemId = Model.LineItemDetail.LineItemId, lineItemDetailId = Model.LineItemDetail.NavigationDetails.FirstId }) %>'"
      type="button" />
    <input class="secondaryButton" value="Previous" onclick="javascript:location.href='<%: Url.Action(actionToRedirect, "MiscPayCreditNote", new { invoiceId = Model.LineItemDetail.LineItem.InvoiceId, lineItemId = Model.LineItemDetail.LineItemId, lineItemDetailId = Model.LineItemDetail.NavigationDetails.PreviousId }) %>'"
      type="button" />
    <%}
       else
       {%>
    ...
    <% if (Model.LineItemDetail.Id != Model.LineItemDetail.NavigationDetails.LastId)
       {%>
    <input class="secondaryButton" value="Next" onclick="javascript:location.href='<%: Url.Action(actionToRedirect, "MiscPayCreditNote", new { invoiceId = Model.LineItemDetail.LineItem.InvoiceId, lineItemId = Model.LineItemDetail.LineItemId, lineItemDetailId = Model.LineItemDetail.NavigationDetails.NextId }) %>'"
      type="button" />
    <input class="secondaryButton" value="Last" onclick="javascript:location.href='<%: Url.Action(actionToRedirect, "MiscPayCreditNote", new { invoiceId = Model.LineItemDetail.LineItem.InvoiceId, lineItemId = Model.LineItemDetail.LineItemId, lineItemDetailId = Model.LineItemDetail.NavigationDetails.LastId }) %>'"
      type="button" />
    <%}
       else
       {%>
    ...
    <% if (ViewData[ViewDataConstants.PageMode] != null && ViewData[ViewDataConstants.PageMode].ToString() == PageMode.View)
       {
         ...
         {
           %>
           <%:Html.LinkButton("Back", Url.Action("LineItemView", "MiscPayCreditNote", new { searchType = "p" }))%>
           <%
         }
         else
         {
