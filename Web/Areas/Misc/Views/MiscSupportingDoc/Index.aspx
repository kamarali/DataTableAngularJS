...
<script type="text/javascript" src="<%:Url.Content("~/Scripts/Misc/SupportingDocument.js")%>"></script>
  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      InitializeAttachmentGrid('<%: new FileAttachmentHelper().GetValidFileExtention(Model.BilledMemberId, BillingCategoryType.Misc) %>', '<%: Url.Action("AttachmentDownload","MiscSupportingDoc") %>');    
    });
  </script>
...
<h1>
  ...
  <div>
    <%
      using (Html.BeginForm("Index", "MiscSupportingDoc", FormMethod.Post, new { id = "SupportingDocSearchForm" }))
      { %>
