...
{
  public class MiscCreditNoteController : MiscUatpControllerBase
  {
    public MiscCreditNoteController(IMiscInvoiceManager miscInvoiceManager, IReferenceManager referenceManager, IMemberManager memberManager)
    ...
    [ISAuthorize(Business.Security.Permissions.Misc.Receivables.CreditNote.View)]
    [HttpGet]
    ...
    [ISAuthorize(Business.Security.Permissions.Misc.Receivables.CreditNote.Validate)]
    [HttpPost]
    [ValidateAntiForgeryToken]
    ...
    [ISAuthorize(Business.Security.Permissions.Misc.Receivables.CreditNote.Submit)]
    [HttpPost]
    [ValidateAntiForgeryToken]
    [RestrictInvoiceUpdate(InvParamName = "invoiceId", IsJson = false, TableName = TransactionTypeTable.INVOICE, ActionParamName = "Edit")]
    ...
    /// <returns></returns>
    [ISAuthorize(Business.Security.Permissions.Misc.Receivables.CreditNote.Download)]
    [HttpGet]
