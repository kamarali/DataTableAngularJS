<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<Iata.IS.Model.Common.MinAcceptableAmount>" %>
<div>
  <h2>
    Search Criteria</h2>
    ...
    <div class="solidBox">
      <div class="fieldContainer horizontalFlow">
        <div>
          ...
          <div>
            <label>
              Applicable Minimum Field:</label>
            <%= Html.ApplicableMinFieldDropdownListFor(model => model.ApplicableMinimumField)%>
          </div>
        </div>
        <div>
          <div>
            <label>
              Rejection Reason Code:</label>
