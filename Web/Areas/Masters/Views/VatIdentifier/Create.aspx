...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    SIS :: Master Maintenance :: General :: Add VAT Identifier Setup
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h1>VAT Identifier Setup</h1> <h2>
        Add VAT Identifier</h2>
     <% using (Html.BeginForm("Create", "VatIdentifier", FormMethod.Post, new { @id = "VatIdentifierMaster" }))
       {%>
    ...
    <fieldset class="solidBox dataEntry">
        <div class="editor-label">
            <label>
                <span class="required">* </span>Identifier:</label>
