...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    SIS :: Master Maintenance :: General :: Edit VAT Identifier Setup
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <h1>VAT Identifier Setup</h1><h2>
        Edit VAT Identifier</h2>
    <% using (Html.BeginForm("Edit", "VatIdentifier", FormMethod.Post, new {  @id = "VatIdentifierMaster" }))
       {%>
    ...
    <fieldset class="solidBox dataEntry">
        <div class="editor-label">
            <label>
                <span class="required">* </span>Vat Identifier:</label>
        ...
        <div class="buttonContainer">
            ...
            <input class="secondaryButton" type="button" value="Back" onclick="javascript:location.href = '<%:Url.Action("Index","VatIdentifier") %>'" />
        </div>
    </fieldset>
    <% } %>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="Script" runat="server">
    <script src="<%:Url.Content("~/Scripts/Masters/VatIdentifierValidate.js")%>" type="text/javascript"></script>
