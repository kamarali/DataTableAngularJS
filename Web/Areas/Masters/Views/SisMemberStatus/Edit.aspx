...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	 SIS :: Master Maintenance :: General :: Edit Member Status Setup
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h1>
        Member Status Setup
    </h1> <h2>Edit Member Status</h2>
    <% using (Html.BeginForm("Edit", "SisMemberStatus", FormMethod.Post, new { @id = "SisMemberStatusMaster" }))
       {%>
       ...
       <fieldset class="solidBox dataEntry">
            <div class="editor-label">
                ...
                <%: Html.TextBoxFor(model => model.MemberStatus, new { @class = "alphabet upperCase", @maxLength = 1, @readonly = "readonly" })%>
