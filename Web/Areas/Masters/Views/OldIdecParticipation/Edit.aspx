...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <h2>
    Edit Old IDEC Participation</h2>
  <% using (Html.BeginForm("Edit", "OldIdecParticipation", FormMethod.Post, new { @id = "OldIdecParticipationMaster" }))
     {%>
  <%: Html.ValidationSummary(true) %>
  <fieldset class="solidBox dataEntry">
    <div class="editor-label">
      <label>
        <span class="required">* </span>Membe:</label>
