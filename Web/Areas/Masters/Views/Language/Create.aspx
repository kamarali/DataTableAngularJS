...
<h1>
    ...
    <% using (Html.BeginForm("Create", "Language", FormMethod.Post, new { @id = "LanguageMaster" }))
       {%>
    ...
    <fieldset class="solidBox dataEntry">
        ...
        <div class="editor-label">
            <label>
                <span class="required">* </span>Language Description:</label>
