...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    SIS :: Master Maintenance :: Area Related :: Edit Area Sub Division Setup
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>
        Edit Sub Division</h2>
    <% using (Html.BeginForm("Edit", "SubDivision", FormMethod.Post, new { @id = "SubDivisionMaster" }))
       {%>
    ...
    <fieldset class="solidBox dataEntry">
        ...
        <div class="editor-label">
            ...
            <%: Html.HiddenFor(model => model.CountryId) %>
             <%: Html.TextBoxFor(model => model.CountryName, new { @class = "alphaNumeric upperCase", @maxLength = 50, @readonly = "readonly" })%>
