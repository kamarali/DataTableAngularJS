...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    SIS :: Master Maintenance :: Area Related :: Add ICAO Country Setup
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>
        Add ICAO Country</h2>
    <% using (Html.BeginForm("Create", "CountryIcao", FormMethod.Post, new { @id = "CountryIcaoMaster" }))
       {%>
    ...
    <fieldset class="solidBox dataEntry">
        <div>
            ...
            <%: Html.TextBoxFor(country => country.CountryCodeIcao, new { @class = "alphabetsOnly upperCase", @maxLength = 2 })%>
        ...
        <div>
            ...
            <%: Html.CheckBoxFor(country => country.IsActive, new { @checked = "checked" })%>
