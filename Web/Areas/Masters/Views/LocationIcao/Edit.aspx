...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    SIS :: Master Maintenance :: Area Related :: Edit ICAO Location Setup
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <h1>
        ICAO Location Setup
    </h1><h2>
        Edit ICAO Location</h2>
    <% using (Html.BeginForm("Edit", "LocationIcao", FormMethod.Post, new { @id = "LocationIcaoMaster" }))
       {%>
    ...
    <fieldset class="solidBox dataEntry">
        <div>
            ...
            <%: Html.TextBoxFor(model => model.Id, new { @class = "alphabetsOnly upperCase", @maxLength = 4, @readonly = "readonly" })%>
