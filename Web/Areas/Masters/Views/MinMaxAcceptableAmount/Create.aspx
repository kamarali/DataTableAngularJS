...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    SIS :: Master Maintenance :: General :: Add Minimum / Maximum Value Setup
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h1>
       Minimum / Maximum Value Setup
    </h1><h2>
        Add Minimum / Maximum Value</h2>
    <% using (Html.BeginForm("Create", "MinMaxAcceptableAmount", FormMethod.Post, new { @id = "MinMaxAcceptableAmountMaster" }))
       {%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Script" runat="server">
    <script src="<%:Url.Content("~/Scripts/Masters/MinMaxAcceptableAmountValidate.js")%>" type="text/javascript"></script>
