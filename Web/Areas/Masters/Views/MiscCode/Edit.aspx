...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    SIS :: Master Maintenance :: General :: Edit Miscellaneous Codes Setup
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h1>
       Miscellaneous Codes Setup
    </h1><h2>
        Edit Miscellaneous Code</h2>
    <% using (Html.BeginForm("Edit", "MiscCode", FormMethod.Post, new { @id = "MiscCodeMaster" }))
       {%>
