...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>
        Edit IS Calendar</h2>
    <% using (Html.BeginForm("Edit", "ISCalendar", FormMethod.Post, new { @id = "ISCalendarMaster" }))
       {%>
    ...
    <fieldset class="solidBox dataEntry">
        ...
        <div class="editor-label">
            ...
            <%:Html.TextBox("EventDateTime", Model.EventDateTime.ToString("yyyy-MM-dd HH:mm:ss"), new { @class = "dateTimePicker", @id = "EventDateTime" })%>
