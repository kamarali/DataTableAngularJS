...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    SIS :: Master Maintenance :: Area Related :: Add UN Location Setup
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>
        Add UN Location</h2>
    <% using (Html.BeginForm("Create", "UnlocCode", FormMethod.Post, new { @id = "UnlocCodeMaster" }))
       {%>
    ...
    <fieldset class="solidBox dataEntry">
        <div>
            ...
            <%: Html.TextBoxFor(model => model.Id, new { @Class = "alphabetsOnly upperCase", @maxLength = 5 })%>
