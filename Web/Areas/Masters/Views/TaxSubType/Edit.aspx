...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    SIS :: Master Maintenance :: Miscellaneous Related :: Edit Tax Sub Type Setup
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h1>
       Tax Sub Type Setup
    </h1> <h2>
        Edit Tax Sub Type</h2>
    <% using (Html.BeginForm("Edit", "TaxSubType", FormMethod.Post, new { @id = "TaxSubTypeMaster" }))
       {%>
