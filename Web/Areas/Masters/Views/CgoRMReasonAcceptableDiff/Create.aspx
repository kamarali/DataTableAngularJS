...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    SIS :: Master Maintenance :: Cargo Related :: Add Reason Code - RM Amount Map
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>
        Add  Reason Code - RM Amount </h2>
    <% using (Html.BeginForm("Create", "CgoRMReasonAcceptableDiff", FormMethod.Post, new { @id = "CgoRMReasonAcceptableDiffMaster" }))
       {%>
    ...
    <fieldset class="solidBox dataEntry">
        ...
        <div class="buttonContainer">
            <input type="submit" value="Save" id="generateButton" class="primaryButton" />
