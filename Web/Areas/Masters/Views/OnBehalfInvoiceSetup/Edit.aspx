...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
     SIS :: Master Maintenance :: General :: Edit Transmitter Exception
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>
        Edit Transmitter Exception</h2>
    <% using (Html.BeginForm("Edit", "OnBehalfInvoiceSetup", FormMethod.Post, new { @id = "OnBehalfInvoiceSetupMaster" }))
       {%>
    ...
    <fieldset class="solidBox dataEntry">
        ...
        <div class="editor-label">
            ...
            <%: Html.ChargeCodeDropdownList("ChargeCodeId",Model.ChargeCodeId,Model.ChargeCategoryId)%>
