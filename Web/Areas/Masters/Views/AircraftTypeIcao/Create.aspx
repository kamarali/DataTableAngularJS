...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
 SIS :: Master Maintenance :: Miscellaneous Related :: Add Aircraft Type ICAO Setup
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h1>
       Aircraft Type ICAO Setup
    </h1> <h2>Add Aircraft Type ICAO </h2>

    <% using (Html.BeginForm("Create", "AircraftTypeIcao", FormMethod.Post, new { @id = "AircraftTypeIcaoMaster" }))
       {%>
