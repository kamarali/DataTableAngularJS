...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        Edit Charge Category</h2>
    <% using (Html.BeginForm("Edit", "ChargeCategory", FormMethod.Post, new { @id = "ChargeCategoryMaster" }))
       {%>
    ...
    <fieldset class="solidBox dataEntry">
        ...
        <div class="editor-label">
            ...
            <%: Html.CheckBoxFor(chargeCategory => chargeCategory.IsActive) %>
