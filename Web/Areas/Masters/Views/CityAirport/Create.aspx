...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    SIS :: Master Maintenance :: Area Related :: Add City and Airport Setup
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h1>
        City and Airport Setup</h1>
    <h2>
        Add City and Airport</h2>
    <% using (Html.BeginForm("Create", "CityAirport", FormMethod.Post, new { @id = "CityAirportMaster" }))
       {%>
