...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	 SIS :: Master Maintenance :: General :: Edit Member Sub Status Setup
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <h1>
        Member Sub Status Setup
    </h1><h2>Edit Member Sub Status</h2>
    <% using (Html.BeginForm("Edit", "SisMemberSubStatus", FormMethod.Post, new { @id = "SisMemberSubStatusMaster" }))
       {%>
       ...
       <fieldset class="solidBox dataEntry">            
            ...
            <div style=" visibility:hidden;">
                <%: Html.TextBoxFor(model => model.BeforeUpdateMemberSubStatus)%>
            </div>
