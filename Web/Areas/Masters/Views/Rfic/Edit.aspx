...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    SIS :: Master Maintenance :: Passenger Related :: Edit EMD RFIC Setup
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>
        Edit EMD RFIC</h2>
    <% using (Html.BeginForm("Edit", "Rfic", FormMethod.Post, new { @id = "RficMaster" }))
       {%>
    ...
    <fieldset class="solidBox dataEntry">
        <div class="editor-label">
            ...
            <%: Html.TextBoxFor(model => model.Id, new { @class = "alphaNumeric", @maxLength = 1, @readonly = "readonly" })%>
