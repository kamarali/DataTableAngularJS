...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    SIS :: Master Maintenance :: Passenger Related :: Add Tax Code Setup
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>
        Add Tax Code</h2>
    <% using (Html.BeginForm("Create", "TaxCode", FormMethod.Post, new { @id = "TaxCodeMaster" }))
       {%>
    ...
    <fieldset class="solidBox dataEntry">
        <div class="editor-label">
            ...
            <%: Html.TextBoxFor(model => model.Id, new { @maxLength = 3, @class = "alphaNumeric" })%>
