...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    SIS :: Master Maintenance :: Miscellaneous Related :: Add Aircraft Type
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h1>
       Aircraft Type Setup
    </h1><h2>
        Add Aircraft Type</h2>
    <% using (Html.BeginForm("Create", "AircraftType", FormMethod.Post, new { @id = "AircraftTypeMaster" }))
       {%>
