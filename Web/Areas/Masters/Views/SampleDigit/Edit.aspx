...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
   SIS :: Master Maintenance :: Passenger Related :: Edit Sample Digit Setup
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   <h1>
       Sample Digit Setup
    </h1> <h2>
        Edit Sample Digit</h2>
    <% using (Html.BeginForm("Edit", "SampleDigit", FormMethod.Post, new { @id = "SampleDigitMaster" }))
       {%>
    ...
    <fieldset class="solidBox dataEntry">
        ...
        <div class="editor-label">
            ...
            <%:Html.TextBox("DigitAnnouncementDateTime", Model.DigitAnnouncementDateTime.ToString(FormatConstants.DateFormat), new { @class = "datePicker", @id = "DigitAnnouncementDateTime" })%>
