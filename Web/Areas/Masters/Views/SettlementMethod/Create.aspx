...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    SIS :: Master Maintenance :: General :: Add SettlementMethod Value Setup
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h1>
       SettlementMethod Value Setup
        ...
        Add SettlementMethod Value</h2>
    <% using (Html.BeginForm("Create", "SettlementMethod", FormMethod.Post, new { @id = "SettlementMethodMaster" }))
       {%>
    ...
    <fieldset class="solidBox dataEntry">
        <div class="editText">
            ...
            <%: Html.TextBoxFor(model => model.Name,new{@maxlength=1})%>
