    ...
    <div class="fieldContainer horizontalFlow">
        ...
        <div>
            <div>
                ...
                <%:Html.TextAreaFor(m => m.ToEmailId, new { @disabled = "disabled", @cols = 150 })%>
            </div>
        </div>
        <div>
      ...
      <%:Html.TextAreaFor(m => m.AdditionalEmailInitiator, new { @cols = 150, @disabled = "disabled" })%>
      </div>
        <div>
      <label for="ToAdditionalEmailIds" class="labelexpandedwidth">
      ...
      <%:Html.TextAreaFor(m => m.AdditionalEmailNonInitiator, new { @cols = 150, @disabled = "disabled" })%>
      </div>
        <div>
        </div>
