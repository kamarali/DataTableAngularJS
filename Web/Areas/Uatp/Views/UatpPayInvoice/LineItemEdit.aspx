...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
  ...
  <% using (Html.BeginForm("LineItemEdit", "UatpInvoice", FormMethod.Post, new { id = "LineItemForm", @class = "validCharacters" }))
     {  %>
  ...
  <div class="buttonContainer">
    ...
    <input class="secondaryButton" type="submit" value="Add New Line Item" id="AddLineItem"
      onclick="javascript:location.href='<%:Url.RouteUrl("UatpLineItem", new{action = "LineItemCreate", controller = "UatpInvoice"})%>'; return false;" />
...
<asp:Content ContentPlaceHolderID="Script" runat="server">
  ...
  <script type="text/javascript">
   ...
   <% if ((string)ViewData[ViewDataConstants.PageMode] != PageMode.View) 
     { %> 
   <%: ScriptHelper.GenerateGridEditDeleteScript(Url, ControlIdConstants.LineItemDetailGridId, Url.Action("LineItemDetailEdit","UatpInvoice"), Url.Action("LineItemDetailDelete", "UatpInvoice"))%>
   <% }
     else 
     {%>
