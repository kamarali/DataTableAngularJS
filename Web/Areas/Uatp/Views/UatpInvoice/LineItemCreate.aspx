...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
  <h1>
    Create Line Item</h1>
  <% using (Html.BeginForm("LineItemCreate", "UatpInvoice", FormMethod.Post, new { id = "LineItemForm", @class = "validCharacters" }))  
     {  %>
