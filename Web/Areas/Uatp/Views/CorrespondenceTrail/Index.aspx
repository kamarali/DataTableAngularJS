...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
  SIS :: Uatp :: Correspondence Report
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="Script" runat="server">
  <script type="text/javascript" src="<%:Url.Content("~/Scripts/Uatp/CorrespondenceTrail.js")%>"></script>
  <script type="text/javascript"> 
   var loggedInMemberId = <%:SessionUtil.MemberId%>;
    
    $(document).ready(function () {   
     RequestForCorrespondenceTrailReportUrl = '<%:Url.Action("RequestForCorrespondenceTrailReport","CorrespondenceTrail",new {area = "Uatp"}) %>';
     RequestForCorrespondenceTrailReportAllUrl = '<%:Url.Action("RequestForCorrespondenceTrailReportAll","CorrespondenceTrail",new {area = "Uatp"}) %>'; 
