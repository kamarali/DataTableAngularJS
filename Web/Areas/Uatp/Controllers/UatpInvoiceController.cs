...
namespace Iata.IS.Web.Areas.Uatp.Controllers
{
  ...
  /// </summary>
  public class UatpInvoiceController : MiscUatpControllerBase
  {
    ...
    public UatpInvoiceController(IUatpInvoiceManager uatpInvoiceManager, IReferenceManager referenceManger, IMemberManager memberManager):base(uatpInvoiceManager, referenceManger, memberManager)
    {
    ...
    [ISAuthorize(Business.Security.Permissions.UATP.Receivables.Invoice.View)]
    [HttpGet]
    ...
    [ValidateAntiForgeryToken]
    [ISAuthorize(Business.Security.Permissions.UATP.Receivables.Invoice.Validate)]
    [HttpPost]
    ...
    [ValidateAntiForgeryToken]
    [ISAuthorize(Business.Security.Permissions.UATP.Receivables.Invoice.Submit)]
    [HttpPost]
    [RestrictInvoiceUpdate(InvParamName = "invoiceId", IsJson = false, TableName = TransactionTypeTable.INVOICE, ActionParamName = "Edit")]
