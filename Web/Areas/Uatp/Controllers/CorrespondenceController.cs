...
namespace Iata.IS.Web.Areas.Uatp.Controllers
{
    public class CorrespondenceController : CorrespondenceControllerBase
    {
      public CorrespondenceController(IMiscCorrespondenceManager miscCorrespondenceManager, ICalendarManager calendarManager, IAuthorizationManager authorizationManager, ICorrespondenceManager correspondenceManager)
        ...
        [ISAuthorize(Business.Security.Permissions.UATP.BillingHistoryAndCorrespondence.BillingHistoryAndCorrespondence.DraftCorrespondence)]
        [HttpGet]
        public ActionResult CreateCorrespondence(string invoiceId, string transactionId)
        {
            return base.CreateCorrespondenceBase(invoiceId, transactionId, ProcessingContactType.UatpCorrespondence);            
        }
        ...
        [ValidateAntiForgeryToken]
        [ISAuthorize(Business.Security.Permissions.UATP.BillingHistoryAndCorrespondence.BillingHistoryAndCorrespondence.SendCorrespondence)]
        [HttpPost]
        ...
        /// <returns></returns>
        [ISAuthorize(Business.Security.Permissions.UATP.BillingHistoryAndCorrespondence.BillingHistoryAndCorrespondence.ViewCorrespondence)]
        [HttpGet]
        ...
        {
            return base.ReplyCorrespondenceBase(invoiceId, transactionId, ProcessingContactType.UatpCorrespondence);
        }
        ...
        /// </summary>
        [ISAuthorize(Business.Security.Permissions.UATP.Receivables.Invoice.Download)]
        [HttpGet]
        ...
        { 
          ...
          try
          {
            string pdfPath = _miscCorrespondenceManager.CreateCorrespondenceFormatPdf(transactionId, ProcessingContactType.UatpCorrespondence);
        ...
        /// <returns></returns>
        [HttpPost]
        public override JsonResult CheckUserSessions()
        {
          return base.CheckUserSessions();
        }
