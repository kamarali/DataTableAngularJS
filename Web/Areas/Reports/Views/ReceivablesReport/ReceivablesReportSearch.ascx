<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<Iata.IS.Model.Reports.ReceivablesReport.ReceivablesReportModel>" %>
<h2>
    Search Criteria</h2>
    ...
    <div class="fieldContainer horizontalFlow">
        ...
        <div style="width:750px;">
            <div style="width:250px;">
                ...
                <%:Html.TextBoxFor(model => model.BilledEntityCodeId, new { @id = "BilledEntityCodeId", @class = "hidden" })%>
            </div>
            <div style="width:250px;">
                <div>
                    <label>
