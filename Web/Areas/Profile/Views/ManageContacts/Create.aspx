...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h1>
        Add Contact Type</h1>
    <% using (Html.BeginForm("Create", "ManageContacts", FormMethod.Post, new { @id = "ContactsMaster" }))
       {%>
        ...
        <div class="fieldContainer horizontalFlow">
            ...
            <div>
                <div>
                    <label>
                        Member</label>
                    <%: Html.RadioButton("rbContactType", "Member", false)%>
                </div>
                <div>
                    <label>
                        PAX</label>
                    <%: Html.RadioButton("rbContactType", "Pax", false)%>
                </div>
            </div>
            <div>
                <div>
                    <label>
                        Cargo</label>
                    <%: Html.RadioButton("rbContactType", "Cgo", false)%>
                </div>
                <div>
                    <label>
                        Miscelleneous</label>
                    <%: Html.RadioButton("rbContactType", "Misc", false)%>
                </div>
            </div>
            <div>
                <div>
                    <label>
                        UATP</label>
                    <%: Html.RadioButton("rbContactType", "Uatp", false)%>
                </div>
                <div>
                    <label>
                        ICH</label>
                    <%: Html.RadioButton("rbContactType", "Ich", false)%>
                </div>
            </div>
            <div class="bottomLine">
                <div>
                    <label>
                        ACH</label>
                    <%: Html.RadioButton("rbContactType", "Ach", false)%>
                </div>
            </div>
            <div>
                <div>
