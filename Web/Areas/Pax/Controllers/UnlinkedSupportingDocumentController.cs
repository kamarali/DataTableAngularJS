...
namespace Iata.IS.Web.Areas.Pax.Controllers
{
  public class UnlinkedSupportingDocumentController : ISController
  {
    ...
    [HttpGet]
    [ISAuthorize(Business.Security.Permissions.Pax.Receivables.CorrectSupportingDocumentsLinkingErrors.Correct)]
