...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div>
   ...
   <%
    ...
    {%>
  <%:ScriptHelper.GeneratePaxPayablesGridViewRejectScript(Url, ControlIdConstants.RejectionMemoGridId, Url.Action("RMView"), "RM", Model.Id.Value(), Url.Action("InitiateRejection", "FormFPayables", new { area = "Pax" }), Url.Action("InitiateDuplicateRejection", "FormFPayables", new { area = "Pax" }), Model.BillingCode, Model.BillingYear, Model.BillingMonth, Model.BillingPeriod, Model.SettlementMethodId)%>
  <%} %>
  ...
  <div class="buttonContainer">
    ...
    <div id="divTransactions">
      <% using (Html.BeginForm(((ViewData[ViewDataConstants.PageMode].ToString() == PageMode.View) ? "VatView" : "Vat"), "FormFPayables", new { invoiceId = Model.Id.Value() }, FormMethod.Get))
         { %>
