...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div class="buttonContainer">
    <% if (Model.Invoice.InvoiceStatusId >= Convert.ToInt32(InvoiceStatusType.ReadyForBilling) && Model.Invoice.InvoiceStatusId < Convert.ToInt32(InvoiceStatusType.ReadyForSubmission))
       {%>
    <input class="secondaryButton" type="button" value="Back" onclick="javascript:location.href = '<%: Url.Action("RMView", "FormXF", new { invoiceId = Model.InvoiceId.Value(), transactionId = Model.Id.Value() } ) %>'" />
    <%}
       else
       {%>
