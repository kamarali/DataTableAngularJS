...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div class="buttonContainer">
    <div>
      <input class="secondaryButton" type="button" value="Back" onclick="javascript:location.href = '<%: Url.Action("RMView", "FormXF", new { invoiceId = Model.RejectionMemoRecord.InvoiceId.Value(), transactionId = Model.RejectionMemoId.Value() } ) %>'" />
    </div>
    <%} %>
  </div>
