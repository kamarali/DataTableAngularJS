    ...
    <div>
      <div>
       ...
       <%-- <%: Html.TextBoxFor(bmRecord => bmRecord.CorrespondenceRefNumber, new { @class = "integer", @maxLength = 11 })%>--%>
          <%: Html.TextBox("CorrespondenceRefNumber", Model.CorrespondenceRefNumber != 0 ? Model.CorrespondenceRefNumber.ToString(FormatConstants.CorrespondenceNumberFormat) : string.Empty, new { @class = "numeric", maxLength = 11 })%>
      </div>
      <div>
        <label for="FIMNumber">
          FIM Number:</label>
