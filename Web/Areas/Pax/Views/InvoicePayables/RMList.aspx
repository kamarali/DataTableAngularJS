...
<asp:Content ID="Content3" ContentPlaceHolderID="Script" runat="server">
  ...
  <%
    ...
    {%>
  <%:ScriptHelper.GeneratePaxPayablesGridViewRejectScript(Url, ViewDataConstants.RejectionMemoListGrid, Url.Action("RMView"), "RM", Model.Id.Value(), Url.Action("InitiateRejection", "InvoicePayables", new { area = "Pax" }), Url.Action("InitiateDuplicateRejection", "InvoicePayables", new { area = "Pax" }), Model.BillingCode, Model.BillingYear, Model.BillingMonth, Model.BillingPeriod, Model.SettlementMethodId)%>
  <%} %>
