...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
  SIS :: Passenger :: Receivables :: Form XF Invoice Level VAT Capture
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div class="buttonContainer">
    <input class="primaryButton" type="button" value="Add to Invoice VAT" onclick="copyUnappliedVat()" id = "AddUnappliedVat"/>
     ...
     <% if ((string)ViewData[ViewDataConstants.PageMode] == PageMode.View)
       {%>
    <input class="secondaryButton" type="button" value="Back" onclick="javascript:location.href = '<%:Url.Action("View", "FormXFPayables", new { invoiceId = Model.Id.Value() })%>';" />
    <%
      }
       else
       {%>
