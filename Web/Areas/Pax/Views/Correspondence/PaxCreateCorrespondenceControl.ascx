...
%>
        ...
        <div>
            ...
            <%: Html.TextBoxFor(corr => corr.Subject, new { @style = "width: 740px;", maxLength = 250 })%>
        </div>
        <div><br /></div>
        <div>
            ...
            <%: Html.TextAreaFor(corr => corr.CorrespondenceDetails, new { @rows = 15, @cols = 150, @class = "textAreaTrimText" })%>
        </div>
        <div><br /></div>
    </div>
    <div class="clear">
