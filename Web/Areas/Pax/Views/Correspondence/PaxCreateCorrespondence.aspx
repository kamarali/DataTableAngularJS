...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  <h1>
    Correspondence</h1>
  <% using (Html.BeginForm("PaxCreateCorrespondence", "Correspondence", new { invoiceId = ViewData[ViewDataConstants.InvoiceId] }, FormMethod.Post, new { id = ControlIdConstants.CorrespondenceHeader }))
     {  %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Script" runat="server">
  ...
  <script type="text/javascript">
		...
		$(document).ready(function () {    
			saveAction = '<%: Url.Action("PaxCreateCorrespondence","Correspondence", new {invoiceId = Request.RequestContext.RouteData.Values["invoiceId"]}) %>';
