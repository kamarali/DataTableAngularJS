<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<Iata.IS.Model.Pax.RejectionMemoVat>" %>
  ...
  <div class="fieldContainer horizontalFlowFor4FieldsPerLine" id="divVatDetails">
    <div id="">
      ...
      <div>
        ...
        <%: Html.TextBox("VatBaseAmount", Model.VatBaseAmount, new { @class = "numeric amount" }) %>
      </div>
      <div>
