  ...
  <div class="fieldContainer horizontalFlow">
    <div class="bottomLine">
      <div>
        ...
        <%:Html.TextBoxFor(m => m.BatchSequenceNumber, new { @class = "digits", @maxLength = 5 })%>
      </div>
      <div>
        <label>
          <span class="required">*</span> Sequence Number:</label>
        <%:Html.TextBoxFor(m => m.RecordSequenceWithinBatch, new { @class = "digits", @maxLength = 5 })%>
      </div>
    </div>
    <div class="bottomLine">
      <div>
      ...
      <div>
        ...
        <%: Html.HiddenFor(formCCoupon => formCCoupon.CouponAwbBreakdownMandatory)%>
      </div>
      <div>
        <label>
          Our Reference:</label>
    ...
    <div class="bottomLine">
      ...
      <% if (Model.Invoice.BillingCode == Convert.ToInt32(BillingCode.SamplingFormXF))
         {%>
      <div>
        <label>
           <span class="required">*</span>Your Rejection Memo Number:</label>
...
%>
      <div>
        <input class="primaryButton hidden" type="button" value="Validate Linking Details" id="FetchButton" />
      </div>
      <%
        }
%>
    ...
    <div class="bottomLine">
      ...
      <%:Html.TextAreaFor(m => m.ReasonRemarks, 10, 80, new { maxlength = "4000" })%>
    </div>
    <div class="bottomLine">
      <table cellpadding="2" cellspacing="0" id="amountFieldsTable" class="amountFieldsTable">
        ...
        <tbody align="center" valign="middle">
          <tr>
            ...
            <td>
              <%:Html.TextBoxFor(m => m.TotalGrossAmountBilled, new
{
  @class = "smallTextField amt_12_3 amount",
  watermark = ControlIdConstants.PositiveAmount
})%>
            </td>
            <td>
              <%:Html.TextBoxFor(m => m.TotalGrossAcceptedAmount, new
{
  @class = "smallTextField amt_12_3 amount",
  watermark = ControlIdConstants.PositiveAmount
})%>
            ...
            <td colspan="2" align="left">
              <%:Html.TextBoxFor(m => m.TotalGrossDifference, new
{
  @class = "smallTextField amt_12_3 derived amount",
  @readOnly = true
})%>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <%:Html.TextBoxFor(m => m.TotalTaxAmountBilled, new
{
  @class = "smallTextField amt_12_3 amount",
  watermark = ControlIdConstants.PositiveAmount
})%>
            ...
            <td>
              <%:Html.TextBoxFor(m => m.TotalTaxAmountAccepted, new
{
  @class = "smallTextField amt_12_3 amount",
  watermark = ControlIdConstants.PositiveAmount
})%>
            ...
            <td colspan="2" align="left">
              <%:Html.TextBoxFor(m => m.TotalTaxAmountDifference, new
{
  @class = "smallTextField amt_12_3 derived amount",
  @readOnly = true
})%>
          ...
          <tr>
            ...
            <td>
              <%:Html.TextBoxFor(m => m.AllowedIscAmount, new
{
  @class = "smallTextField amt_12_3 amount",
  watermark = ControlIdConstants.NegativeAmount
})%>
            </td>
            <td>
              <%:Html.TextBoxFor(m => m.AcceptedIscAmount, new
{
  @class = "smallTextField amt_12_3 amount",
  watermark = ControlIdConstants.NegativeAmount
})%>
            ...
            <td align="left">
              <%:Html.TextBoxFor(m => m.IscDifference, new
{
  @class = "smallTextField amt_12_3 derived amount",
  @readOnly = true
})%>
          ...
          <tr>
            ...
            <td>
              <%:Html.TextBoxFor(m => m.AllowedUatpAmount, new
{
  @class = "smallTextField amt_12_3 amount",
  watermark = ControlIdConstants.NegativeAmount
})%>
            ...
            <td>
              <%:Html.TextBoxFor(m => m.AcceptedUatpAmount, new
{
  @class = "smallTextField amt_12_3 amount",
  watermark = ControlIdConstants.NegativeAmount
})%>
            ...
            <td align="left">
              <%:Html.TextBoxFor(m => m.UatpAmountDifference, new
{
  @class = "smallTextField amt_12_3 derived amount",
  @readOnly = true
})%>
          ...
          <tr>
            ...
            <td>
              <%:Html.TextBoxFor(m => m.AllowedHandlingFee, new
{
  @class = "smallTextField amt_10_3 amount",
  watermark = ControlIdConstants.PositiveAmount
})%>
            </td>
            <td>
              <%:Html.TextBoxFor(m => m.AcceptedHandlingFee, new
{
  @class = "smallTextField amt_10_3 amount",
  watermark = ControlIdConstants.PositiveAmount
})%>
            ...
            <td align="left">
              <%:Html.TextBoxFor(m => m.HandlingFeeAmountDifference, new
{
  @class = "smallTextField amt_10_3 derived amount",
  @readOnly = true
})%>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <%:Html.TextBoxFor(m => m.AllowedOtherCommission, new
{
  @class = "smallTextField amt_12_3 amount",
  watermark = ControlIdConstants.NegativeAmount
})%>
            ...
            <td>
              <%:Html.TextBoxFor(m => m.AcceptedOtherCommission, new
{
  @class = "smallTextField amt_12_3 amount",
  watermark = ControlIdConstants.NegativeAmount
})%>
            ...
            <td align="left">
              <%:Html.TextBoxFor(m => m.OtherCommissionDifference, new
{
  @class = "smallTextField amt_12_3 derived amount",
  @readOnly = true
})%>
          ...
          <tr>
            ...
            <td>
              <%:Html.TextBoxFor(m => m.TotalVatAmountBilled, new
{
  @class = "smallTextField amt_12_3 amount",
  watermark = ControlIdConstants.NegativeAmount
})%>
            ...
            <td>
              <%:Html.TextBoxFor(m => m.TotalVatAmountAccepted, new
{
  @class = "smallTextField amt_12_3 amount",
  watermark = ControlIdConstants.NegativeAmount
})%>
            ...
            <td colspan="2" align="left">
              <%:Html.TextBoxFor(m => m.TotalVatAmountDifference, new
{
  @class = "smallTextField amt_12_3 derived amount",
  @readOnly = true
})%>
          ...
          <tr>
            ...
            <td align="left">
              <%:Html.TextBoxFor(m => m.TotalNetRejectAmount, new
{
  @class = "smallTextField derived amount",
  @readOnly = true,
  min = 0,
  max = 9999999999999.9
})%>
          ...
          <tr>
            ...
            <td align="left">
              <%:Html.TextBox(ControlIdConstants.SamplingConstant, Model.SamplingConstant, new { @class = "smallTextField populated derived percent", @readOnly = true })%>
            </td>
          </tr>
          <tr>
            <td style="font-weight: bold;" align="left">
              Net Reject Amount after Sampling Constant
            </td>
            <td>
            </td>
            <td>
            ...
            <td align="left">
              <%:Html.TextBoxFor(m => m.TotalNetRejectAmountAfterSamplingConstant, new
{
  @class = "smallTextField derived amount",
  @readOnly = true
})%>
    ...
    <div>
      <div>
        ...
        <a class="ignoredirty" onclick="return openAttachment();" href="#">Attachment</a>
      </div>
      <div>
        <label>
