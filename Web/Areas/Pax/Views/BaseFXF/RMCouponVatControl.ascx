<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<List<Iata.IS.Model.Pax.RMCouponVat>>" %>
<%@ Import Namespace="Iata.IS.Model.Pax" %>

<form id="formVatDetails" method="get" action=""> 
<div>
  <% Html.RenderPartial("~/Areas/Pax/Views/BaseFXF/RMCouponVatDetailsControl.ascx", new RMCouponVat());%>
</div>
