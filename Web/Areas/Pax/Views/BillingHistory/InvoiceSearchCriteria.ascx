<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<Iata.IS.Model.Pax.BillingHistory.InvoiceSearchCriteria>" %>
<h2>
  ...
  <div class="fieldContainer horizontalFlow">
    ...
    <div>
      ...
      <div>
        ...
        <%:Html.MemoTypeDropdownlistFor(model => model.MemoTypeId ) %>        
      </div>
      <div>
      ...
      <div>
        ...
        <%:Html.TextBoxFor(model => model.SourceCodeId, new { maxLength = 10, @class = "autocComplete" })%>        
      </div>      
  </div>
  <div>
    <div>
      ...
      <div>
        ...
        <%: Html.TextBoxFor(model => model.DocumentNumber, new { @class = "integer", maxLength = 11 })%>  
      </div>
      <div>
        <label for="CouponNumber">Coupon Number:</label>
        <%: Html.TextBoxFor(model => model.CouponNumber, new { @class = "integer", maxLength = 1 })%>  
      </div>
    </div>
  </div>
  <div class="clear">
