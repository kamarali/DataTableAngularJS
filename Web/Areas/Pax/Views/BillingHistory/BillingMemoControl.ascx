    ...
    <tbody>
      <tr>
        ...
        <td>
          ...
          <%: Model.NetAmountBilled.ToString(FormatConstants.TwoDecimalsFormat)%>
        </td>
      </tr>
    </tbody>
  </table>
  ...
  <table class="formattedTable">
    ...
    <tbody>
      <tr>
        ...
        <td>
          <% if(Model.CorrespondenceRefNumber !=0 )%>
               <%: Model.CorrespondenceRefNumber %>
...
%>
      ...
      <%
    foreach (BMCoupon couponRecord in Model.CouponBreakdownRecord)
    {
      %>
<div>
  <table class="formattedTable">
    ...
    <tbody>
        ...
        <td class="numeric">
          <%:couponRecord.GrossAmountBilled.ToString(FormatConstants.TwoDecimalsFormat)%>
        </td>
        <td class="numeric">
        ...
        <td class="numeric">
          <%:couponRecord.NetAmountBilled.ToString(FormatConstants.TwoDecimalsFormat)%>
        </td>
        <td>
...
<div>
  ...
  <%
    ...
    {  
  %>
  <a href="<%:Url.Action("BillingHistoryBMCouponAttachmentDownload", new {invoiceId = attachment.Id}) %>">
    <%:attachment.OriginalFileName%></a><br />
  <%
    }
  %>
