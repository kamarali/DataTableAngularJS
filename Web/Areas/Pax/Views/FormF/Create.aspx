...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
  SIS :: Passenger :: <%: ViewData[ViewDataConstants.BillingType].ToString() %> :: Create Sampling Form F"
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  <h1>
    Create Sampling Form F
  </h1>
  <% using (Html.BeginForm("Create", "FormF", FormMethod.Post, new { id = "SamplingRMForm", @class = "validCharacters" }))
     {%>
  ...
  <div class="buttonContainer">
    <input class="primaryButton ignoredirty" type="submit" value="Save Form F Header" />
  </div>
  <%
    }%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Script" runat="server">
  ...
  <%
     ...
     InitializeLinking('<%:Url.Action("GetFormDESamplingConstant", "Data",  new { area = ""}) %>', '<%:SessionUtil.MemberId %>');
