...
<asp:Content ID="titleBlock" ContentPlaceHolderID="TitleContent" runat="server">
  SIS :: Passenger :: <%: ViewData[ViewDataConstants.BillingType].ToString() %> :: <%:ViewData[ViewDataConstants.PageMode] %> Credit Note
</asp:Content>
...
<script type="text/javascript">
  ...
  <%
    ...
    /*CMP #596: Length of Member Accounting Code to be Increased to 12 
        ...
        Ref: FRS Section 3.4 Table 15 Row 3 */
...
<asp:Content ID="contentBlock" ContentPlaceHolderID="MainContent" runat="server">
  <h1>
    Create Non-Sampling Credit Note</h1>
