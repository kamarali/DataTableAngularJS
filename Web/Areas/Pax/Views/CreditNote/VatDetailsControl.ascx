<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<Iata.IS.Model.Pax.CreditMemoVat>" %>
  ...
  <div class="fieldContainer horizontalFlowFor4FieldsPerLine" id="divVatDetails">
    <div id="">
      ...
      <div>
        ...
        <%: Html.TextBox("VatLabel", Model.VatLabel, new { @class = "popupTextField" })%>
      </div>
      <div>
        <label for="VATText">
