<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<List<Iata.IS.Model.Pax.BMCouponTax>>" %>
<%@ Import Namespace="Iata.IS.Model.Pax" %>
<form id="formTaxDetails" method="get" action=""> 
<div>
  <% Html.RenderPartial("BillingMemoTaxDetailsControl", new BMCouponTax());%>
</div>
