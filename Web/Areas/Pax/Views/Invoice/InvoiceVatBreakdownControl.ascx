<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewPage<Iata.IS.Model.Pax.InvoiceTotalVat>" %>
  ...
  <div class="fieldContainer horizontalFlow">
    <div>
      ...
      <div>
        ...
        <%= Html.TextBoxFor(vat => vat.VatText, new { @class = "largeTextField" })%>
      </div>
      <div>
