...
<asp:Content runat="server" ID="Content1" ContentPlaceHolderID="Script">
  ...
  <%
    ...
    function formatSourceCodeVatTotalColumn(cellValue, options, rowObject) {
      ...
      var linkHtml = '<a href="#" onclick=showSourceCodeVatDialog("<%: Url.Action("GetBillingCodeVatTotal", "Invoice", new { area = "Cargo" })%>","' + sourceCodeId + '")>' + "Source Code VAT" + '</a>';
      // return link
      return linkHtml;
    }      
  </script>
    ...
    <div class="buttonContainer">
      ...
      <div class="viewModeDisplayButtons">
        ...
        <%
          ...
          using (Html.BeginForm(((ViewData[ViewDataConstants.PageMode].ToString() == PageMode.View) ? "PrimeBillingListView" : "PrimeBillingList"), "Invoice", FormMethod.Get))
          {%>
        ...
        <%
          ...
          using (Html.BeginForm(((ViewData[ViewDataConstants.PageMode].ToString() == PageMode.View) ? "RMListView" : "RMList"), "Invoice", FormMethod.Get))
          {%>
        ...
        using (Html.BeginForm(((ViewData[ViewDataConstants.PageMode].ToString() == PageMode.View) ? "BMListView" : "BMList"), "Invoice", FormMethod.Get))
        {%>
