...
<div class="buttonContainer">
  ...
  <form id="ajaxUploadForm" action="<%: Url.Action("CreditMemoCouponAttachmentUpload", "CreditNote", new { invoiceId = Model.CreditMemoRecord.Invoice.Id, transactionId = Model.Id })%>"
