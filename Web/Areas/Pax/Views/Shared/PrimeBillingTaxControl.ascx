<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<List<Iata.IS.Model.Pax.PrimeCouponTax>>" %>
<%@ Import Namespace="Iata.IS.Model.Pax" %>
<form id="formTaxDetails" method="get" action=""> 
<div>
  <% Html.RenderPartial("PrimeBillingTaxDetailsControl", new PrimeCouponTax());%>
</div>
