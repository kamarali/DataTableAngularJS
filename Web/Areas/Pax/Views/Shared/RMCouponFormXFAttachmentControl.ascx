...
<div class="buttonContainer">
  ...
  <form id="ajaxUploadForm" action="<%: Url.Action("RMCouponFormFXFAttachmentUpload", "FormXF", new { invoiceId = Model.RejectionMemoRecord.InvoiceId, transactionId = Model.Id })%>"
