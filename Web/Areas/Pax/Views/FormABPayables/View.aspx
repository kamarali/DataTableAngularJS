...
<asp:Content runat="server" ID="Content1" ContentPlaceHolderID="Script">
  ...
  <script type="text/javascript">
    ...
    function formatSourceCodeVatTotalColumn(cellValue, options, rowObject) {
      ...
      var linkHtml = '<a href="#" onclick=showSourceCodeVatDialog("<%: Url.Action("GetSourceCodeVatTotal", "FormABPayables", new { area = "Pax" })%>","' + sourceCodeId + '")>' + "Source Code VAT" + '</a>';
      // return link
      return linkHtml;
    }            
  </script>
  ...
  <h2>
    ...
    <div class="buttonContainer">
      <div class="viewModeDisplayButtons">
        <%
          using (Html.BeginForm("VatView", "FormABPayables", FormMethod.Get))
          {%>
        ...
        <%
          using (Html.BeginForm("PrimeBillingListView", "FormABPayables", FormMethod.Get))
          {%>
