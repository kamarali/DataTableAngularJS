...
<%: ScriptHelper.GenerateSupportingDocDeleteScript(Url, ControlIdConstants.AttachmentGrid,
                    Url.Action("AttachmentDelete", "MiscPayableSupportingDoc", new { area = "Misc" }))%>
<div style=" visibility:hidden">
  <form id="ajaxUploadForm" action="<%: Url.Action("UploadAttachment", "MiscPayableSupportingDoc", new {area = "Misc"})%>"
