...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    SIS :: Miscellaneous :: Receivables :: Manage Supporting Documents
</asp:Content>

<asp:Content ID="Content3" ContentPlaceHolderID="Script" runat="server">
<script type="text/javascript" src="<%:Url.Content("~/Scripts/Misc/PayableSupportingDocument.js")%>"></script>
  ...
  <script type="text/javascript">
      ...
      InitializeAttachmentGrid('<%: new FileAttachmentHelper().GetValidFileExtention(Model.BillingMemberId, BillingCategoryType.Misc) %>', '<%: Url.Action("AttachmentDownload","MiscPayableSupportingDoc") %>');    
      function resetForm() {
...
<h1>
  ...
  <div>
    <%
        using (Html.BeginForm("PayableSupportingDocs", "MiscPayableSupportingDoc", FormMethod.Post, new { id = "SupportingDocSearchForm" }))
      { %>
