<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<Iata.IS.Model.Cargo.SearchCriteria>" %>
    ...
    <div class="fieldContainer horizontalFlow">
      <div>
       ...
       <%-- <div>
        ...
        <div>
          ...
          <%:Html.CgoInvoiceStatusDropdownListFor(m => m.InvoiceStatus, true)%>
      ...
      <div>
        ...
        <div>
          ...
          <%:Html.SubmissionMethodDropDownListFor(m => m.SubmissionMethodId, true, isForCargo: true)%>
        </div>
        </div>
    </div>
    <div class="clear">
