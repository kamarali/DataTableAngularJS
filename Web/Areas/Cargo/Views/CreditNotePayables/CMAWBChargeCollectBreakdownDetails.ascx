    ...
    <div class="fieldContainer horizontalFlow">
      ...
      <div>
        ...
        <div>
         ...
         <%:Html.TextBoxFor(awbRecord => awbRecord.CreditedValuationCharge, new { @class = "amount amt_11_3", watermark = ControlIdConstants.PositiveAmount })%>
        </div>
        <div>
         <label>Amount Subjected To ISC:</label>
          <%:Html.TextBoxFor(awbRecord => awbRecord.CreditedAmtSubToIsc, new { @class = "amountTextfield amount amt_11_3", watermark = ControlIdConstants.PositiveAmount })%>
        </div>
        <div>
         <label>ISC %:</label>
        ...
        <div>
         ...
         <%:Html.TextBoxFor(awbRecord => awbRecord.CreditedIscAmount, new { @class = "amountTextfield amount amt_11_3", @readOnly = true, watermark = ControlIdConstants.NegativeAmount })%>
        </div>
      </div>
      <div>
      <div>
