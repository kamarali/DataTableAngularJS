...
<div class="buttonContainer">
  ...
  <form id="ajaxUploadForm" action="<%: Url.Action("CreditMemoAttachmentUpload", "CreditNotePayables", new {Area="Cargo",invoiceId = Model.InvoiceId, transactionId = Model.Id })%>"
