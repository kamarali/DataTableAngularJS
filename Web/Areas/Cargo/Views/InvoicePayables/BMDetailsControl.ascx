    ...
    <div class="bottomLine">
      ...
      <div>
       ...
       <%-- <%:Html.TextBoxFor(bm => bm.CorrespondenceReferenceNumber, new { @maxLength = 11, @class = "numeric" })%>--%>
        <%: Html.TextBox("CorrespondenceReferenceNumber", Model.CorrespondenceReferenceNumber != 0 ? Model.CorrespondenceReferenceNumber.ToString(FormatConstants.CorrespondenceNumberFormat) : string.Empty, new { @class = "numeric", maxLength = 11 })%>
      </div>
    </div>
    <div>
      <div>
