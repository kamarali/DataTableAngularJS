<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<Iata.IS.Model.Cargo.BMAwbVat>" %>
  ...
  <div class="fieldContainer horizontalFlowFor4FieldsPerLine" id="divVatDetails">
    ...
    <div>
      ...
      <div>
        ...
        <%: Html.TextBox("VatPercentage", Model.VatPercentage, new { @class = "percentageTextfield percent amt_5_3", watermark = ControlIdConstants.NegativePercentage })%>
      </div>
      <div>
        <label for="VATCalculatedAmount">
          VAT Calculated Amount:</label>
        <%: Html.TextBox("VatCalculatedAmount", "", new { @readonly = "true", @class = "amount amt_11_3" })%>
