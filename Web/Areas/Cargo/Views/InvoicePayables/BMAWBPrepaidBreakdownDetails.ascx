    ...
    <div class="fieldContainer horizontalFlow">
      ...
      <div>
        <div>
         ...
         <%:Html.TextBoxFor(awbRecord => awbRecord.BilledWeightCharge, new { @class = "breakDownDerived amount amt_11_3", watermark = ControlIdConstants.PositiveAmount })%>
        </div>
        <div>
         <label>Valuation Charges:</label>
         <%:Html.TextBoxFor(awbRecord => awbRecord.BilledValuationCharge, new { @class = "breakDownDerived amount amt_11_3", watermark = ControlIdConstants.PositiveAmount })%>
        </div>
        <div>
         <label>ISC </label>
         <%:Html.TextBoxFor(awbRecord => awbRecord.BilledIscPercentage, new { @class = "percentageTextfield percent amt_5_3", watermark = ControlIdConstants.NegativePercentage })%>&nbsp;%&nbsp;
         <%:Html.TextBoxFor(awbRecord => awbRecord.BilledIscAmount, new { @class = "amountTextfield breakDownDerived amount amt_11_3", @readOnly = true, watermark = ControlIdConstants.NegativeAmount })%>&nbsp;Amount
        </div>
        <%-- <div>
         <label>ISC Amount:</label>
         <%:Html.TextBoxFor(awbRecord => awbRecord.BilledIscAmount, new { @class = "breakDownDerived amount", @readOnly = true, min = -99999999999.99, max = 99999999999.99, watermark = ControlIdConstants.NegativeAmount })%>&nbsp;Amount
        </div>--%>
        <div>
         <label>Other Charges:</label>
          <%:Html.TextBoxFor(awbRecord => awbRecord.BilledOtherCharge, new { id = "OtherChargeAmount", @class = "amountTextfield amount amt_11_3", @readOnly = true, watermark = ControlIdConstants.PositiveAmount })%>
      ...
      <div id="divReasonCode">
        <div>
          <label for="reasonCode">
            Reason Code:</label>
          <%:Html.TextBoxFor(awbRecord => awbRecord.ReasonCode, new { maxLength = 2 })%>
        </div>
        <div>
