...
<div class="buttonContainer">
  ...
  <form id="ajaxUploadForm" action="<%: Url.Action("BMAwbAttachmentUpload", "Invoice", new {Area="Cargo",invoiceId = Model.BillingMemoRecord.Invoice.Id, transactionId = Model.Id })%>"
