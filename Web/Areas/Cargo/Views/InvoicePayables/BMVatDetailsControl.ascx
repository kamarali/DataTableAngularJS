<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<Iata.IS.Model.Cargo.CargoBillingMemoVat>" %>
  ...
  <div class="fieldContainer horizontalFlowFor4FieldsPerLine" id="divVatDetails">
    <div id="">
      ...
      <div>
        ...
        <%: Html.TextBox("VatPercentage", Model.VatPercentage, new { @class = "percentageTextfield percent amt_5_3", min = -99.999, max = 99.999, watermark = ControlIdConstants.NegativePercentage })%>
      </div>
      <div>
