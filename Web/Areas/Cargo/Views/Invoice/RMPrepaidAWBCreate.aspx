...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
   SIS :: Cargo :: <%: ViewData[ViewDataConstants.BillingType].ToString() %> :: Add Prepaid AWB
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div class="buttonContainer">
     <input type="submit" value="Save and Add New" class="primaryButton ignoredirty" id="btnSaveAndAddNew"
      onclick="javascript:return SaveRMAwbRecord('<%: Url.Action("RMPrepaidAwbCreate","Invoice", new { invoiceId = Model.RejectionMemoRecord.InvoiceId, transactionId = Model.RejectionMemoRecord.Id }) %>')" />
    <input type="submit" value="Save and Duplicate" class="primaryButton ignoredirty"
      id="btnSaveAndDuplicate" onclick="javascript:return SaveRMAwbRecord('<%: Url.Action("RMPrepaidAwbDuplicate","Invoice", new { invoiceId = Model.RejectionMemoRecord.InvoiceId, transactionId = Model.RejectionMemoRecord.Id }) %>')" />
    <input type="submit" value="Save and Back to Overview" class="primaryButton ignoredirty"
      id="SaveAndBackToOverview" onclick="javascript:return SaveRMAwbRecord('<%: Url.Action("RMPrepaidAwbCreateAndReturn","Invoice", new { invoiceId = Model.RejectionMemoRecord.InvoiceId, transactionId = Model.RejectionMemoRecord.Id }) %>')" />
