...
<script src="<%:Url.Content("~/Scripts/Cargo/AwbRecord.js")%>" type="text/javascript"></script>
  ...
  %>
  -
  <%:ScriptHelper.GenerateGridViewScript(Url, ViewDataConstants.PrimeBillingGrid, Url.Action("AwbPrepaidBillingView", "Invoice", new { billingType = ViewData[ViewDataConstants.BillingType].ToString(), invoiceId = Model.Id }))%>
  <%
    }
    else
    {
