<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<List<Iata.IS.Model.Cargo.RMAwbVat>>" %>
<%@ Import Namespace="Iata.IS.Model.Cargo" %>
<form id="formVatDetails" method="get" action="">
<div>
  <% Html.RenderPartial("RMAwbBillingVatDetailsControl", new RMAwbVat());%>
</div>
