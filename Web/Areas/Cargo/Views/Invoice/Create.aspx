 <%@ Page Title="" Language="C#" Inherits="System.Web.Mvc.ViewPage<Iata.IS.Model.Cargo.CargoInvoice>" MasterPageFile="~/Views/Shared/Site.Master" %>
 <%@ Import Namespace="Iata.IS.Model.Enums" %>

<asp:Content runat="server" ID="Content" ContentPlaceHolderID="TitleContent">
  SIS :: Cargo :: <%--<%: ViewData[ViewDataConstants.BillingType].ToString() %>--%> :: Create Invoice 
</asp:Content>
