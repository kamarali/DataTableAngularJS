<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<List<Iata.IS.Model.Cargo.BMAwbOtherCharge>>" %>
<%@ Import Namespace="Iata.IS.Model.Cargo" %>
<form id="formOtherChargDetails" method="get" action="">
<div>
  <% Html.RenderPartial("BMAwbOtherChargeDetailsControl", new BMAwbOtherCharge());%>
</div>
