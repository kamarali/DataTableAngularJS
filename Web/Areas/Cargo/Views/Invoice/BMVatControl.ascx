<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<List<Iata.IS.Model.Cargo.CargoBillingMemoVat>>" %>
<%@ Import Namespace="Iata.IS.Model.Cargo" %>
<form id="formVatDetails" method="get" action=""> 
<div>
  <% Html.RenderPartial("BMVatDetailsControl", new CargoBillingMemoVat());%>
</div>
