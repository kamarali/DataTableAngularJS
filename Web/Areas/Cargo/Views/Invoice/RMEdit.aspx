...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div class="buttonContainer">
    <input type="submit" value="Save" class="primaryButton ignoredirty" id="btnSave" onclick="javascript:return changeAction('<%: Url.RouteUrl("CGOtransactions", new  { action = "RMEdit", controller = "Invoice", area = "Cargo", invoiceId = Model.InvoiceId.Value(), transactionId = Model.Id.Value() } )%>')" />
...
%>
    <%: Html.LinkButton("Back", Url.Action("RMList", "Invoice", new { invoiceId = Model.InvoiceId, billingType = ViewData[ViewDataConstants.BillingType].ToString() }))%>
    <%
      }
     }
        %>
