...
<%@ Import Namespace="Iata.IS.Business.Security" %>
<%@ Import Namespace="Iata.IS.Core.DI" %>
  ...
  <%
      ...
      setInvoiceHeaderFocus();
        ...
        /*CMP #596: Length of Member Accounting Code to be Increased to 12 
            ...
            Ref: FRS Section 3.4 Table 15 Row 21 */
    ...
    function formatBillingCodeVatTotalColumn(cellValue, options, rowObject) {
      ...
      var linkHtml = '<a href="#" onclick=showSourceCodeVatDialog("<%: Url.Action("GetBillingCodeVatTotal", "Invoice", new { area = "Cargo" })%>","' + sourceCodeId + '")>' + "Billing Code VAT" + '</a>';
      // return link
      return linkHtml;
    }      
  </script>
    ...
    <div class="buttonContainer">
      ...
      <div>
        ...
        <%
          ...
          using (Html.BeginForm(((ViewData[ViewDataConstants.PageMode].ToString() == PageMode.View) ? "AwbPrepaidBillingListView" : "AwbPrepaidBillingList"), "Invoice", FormMethod.Get))
          {%>
        ...
        <%
          ...
          using (Html.BeginForm(((ViewData[ViewDataConstants.PageMode].ToString() == PageMode.View) ? "AwbChargeCollectBillingListView" : "AwbChargeCollectBillingList"), "Invoice", FormMethod.Get, new { invoiceId = Model.Id, billingType = ViewData[ViewDataConstants.BillingType].ToString()}))
          {%>
        ...
        <% }
          ...
          using (Html.BeginForm(((ViewData[ViewDataConstants.PageMode].ToString() == PageMode.View) ? "RMListView" : "RMList"), "Invoice", FormMethod.Get, new { invoiceId = Model.Id, billingType = ViewData[ViewDataConstants.BillingType].ToString()}))
            {%>
        ...
        <%
          ...
          using (Html.BeginForm(((ViewData[ViewDataConstants.PageMode].ToString() == PageMode.View) ? "BMListView" : "BMList"), "Invoice", FormMethod.Get, new { invoiceId = Model.Id, billingType = ViewData[ViewDataConstants.BillingType].ToString() }))
          {%>
    ...
    <br/>
      ...
      <%
        ...
        // SCP#419602: SRM: CGO/MISC/UATP and Billing history permissions
          if ((Model.InvoiceStatus == InvoiceStatusType.Open && Html.IsAuthorized(Iata.IS.Business.Security.Permissions.Cargo.Receivables.CreateInvoice.Validate)))
        {
      ...
      <%
          ...
          if (Model.InvoiceStatus == Iata.IS.Model.Enums.InvoiceStatusType.ReadyForSubmission && Html.IsAuthorized(Iata.IS.Business.Security.Permissions.Cargo.Receivables.CreateInvoice.Submit))
        {
