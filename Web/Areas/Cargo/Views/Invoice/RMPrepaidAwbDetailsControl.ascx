...
<div class="solidBox dataEntry">
  <div class="fieldContainer horizontalFlow">
    <div>
      ...
      <%
          if (Model.RejectionMemoRecord.IsLinkingSuccessful == true && Convert.ToBoolean(ViewData["IsAwbLinkingRequired"]))
          {%>
        ...
        <tbody align="center" valign="middle">
          ...
          <tr>
            ...
            <td colspan="2" align="left">
              ...
              <%:ScriptHelper.GenerateDialogueHtml("Other Charges", "RM AWB Prepaid Other Charge Capture", "divOtherCharge", 500, 900)%>
            </td>
          </tr>
          <tr>            
            <td style="font-weight: bold;" align="left">
            ...
            <td colspan="2" align="left">
              ...
              <%:ScriptHelper.GenerateDialogueHtml("VAT Breakdown", "RM AWB Prepaid VAT Capture", "divVatBreakdown", 510, 900, "vatBreakdown")%>
            </td>
          </tr>
          <tr>
            <td>
          ...
          <tr>
            ...
            <td>
              <%:Html.TextBoxFor(coupon => coupon.AllowedIscAmount, new { @class = "smallTextField amountTextfield amt_11_3 amount " })%>
            </td>
            <td>
            ...
            <td>
              <%:Html.TextBoxFor(coupon => coupon.AcceptedIscAmount, new { @class = "smallTextField amountTextfield amt_11_3 amount" })%>
            </td>
            <td align="left">
           ...
           <tr>
            ...
            <td align="left">
              ...
              <%:Html.TextBoxFor(coupon => coupon.NetRejectAmount, new { @class = "smallTextField pos_amt_11_3  amount", @readOnly = true })%>
            </td>
            <td>
              &nbsp;
            </td>
