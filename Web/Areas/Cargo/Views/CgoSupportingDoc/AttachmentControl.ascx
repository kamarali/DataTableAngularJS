<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<Iata.IS.Model.Cargo.Common.SupportingDocumentAttachment>" %>

<%: ScriptHelper.GenerateSupportingDocDeleteScript(Url, ControlIdConstants.AttachmentGrid,
                Url.Action("AttachmentDelete", "CgoSupportingDoc", new { area = "Cargo" }))%>
<div class="buttonContainer">
  <form id="ajaxUploadForm" action="<%: Url.Action("UploadAttachment", "CgoSupportingDoc")%>"
