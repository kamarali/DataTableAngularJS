...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  <script type="text/javascript" src="<%:Url.Content("~/Scripts/Cargo/CargoCorrespondence.js")%>"></script>
  <h1>
    Correspondence</h1>
  <%
    using (
      Html.BeginForm("EditCargoCorrespondence",
                     "Correspondence",
...
<asp:Content ID="Content3" ContentPlaceHolderID="Script" runat="server">
  ...
  <script type="text/javascript">   
    ...
    $(document).ready(function () {          
      saveAction = '<%:Url.Action("EditCargoCorrespondence", "Correspondence", new { invoiceId = Request.RequestContext.RouteData.Values["invoiceId"], transactionId = Model.Id })%>';
