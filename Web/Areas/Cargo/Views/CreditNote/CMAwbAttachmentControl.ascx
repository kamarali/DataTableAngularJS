...
<div class="buttonContainer">
  ...
  <form id="ajaxUploadForm" action="<%: Url.Action("CMAwbAttachmentUpload", "CreditNote", new {Area="Cargo",invoiceId = Model.CreditMemoRecord.Invoice.Id, transactionId = Model.Id })%>"
