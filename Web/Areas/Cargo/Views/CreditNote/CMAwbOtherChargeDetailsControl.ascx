<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<Iata.IS.Model.Cargo.CMAwbOtherCharge>" %>
  ...
  <div class="fieldContainer horizontalFlowFor4FieldsPerLine" id="divOtherChargeDetails">
    <div id="">
      ...
      <div>
        <label for="VatLabel">
           VAT Label:</label>
        <%: Html.TextBox("OtherChargeVatLabel", Model.OtherChargeVatLabel, new { @class = "xlargeTextField popupTextField alphaNumericWithSpace", maxlength = 5 })%>
      </div>
      <div>
        <label for="VATText">
          VAT Text:</label>
    ...
    <div>
      ...
      <div>
        ...
        <%: Html.TextBox("OtherChargeVatCalculatedAmount", "", new { @readonly = "true", id = "OtherChargeVatCalculatedAmount", @class = "amount amt_11_3" })%>
