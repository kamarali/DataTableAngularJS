<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<Iata.IS.Model.Cargo.CargoCreditMemoVat>" %>
  ...
  <div class="fieldContainer horizontalFlowFor4FieldsPerLine" id="divVatDetails">
    <div id="">
      <div>
        ...
        <%: Html.VatIdentifierListDropdownListFor(vat => vat.VatIdentifierId, BillingCategoryType.Cgo)%>
      </div>
      <div>
        <label for="VATLabel">
      ...
      <div>
        ...
        <%: Html.TextBox("VatBaseAmount", Model.VatBaseAmount, new { @class = "amount amt_11_3", min = -99.999, max = 99.999 })%>
      </div>
      <div>
        <label for="VATPercentage">
          <span>*</span>VAT Percentage:</label>
        <%: Html.TextBox("VatPercentage", Model.VatPercentage, new { @class = "percent amt_5_3", min = -99.999, max = 99.999 })%>
      </div>
      <div>
