...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
  SIS :: Cargo :: Correspondence Report
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="Script" runat="server">
  <script type="text/javascript" src="<%:Url.Content("~/Scripts/Cargo/CorrespondenceTrail.js")%>"></script>
  <script type="text/javascript"> 
   var loggedInMemberId = <%:SessionUtil.MemberId%>;
    
    $(document).ready(function () {   
     RequestForCorrespondenceTrailReportUrl = '<%:Url.Action("RequestForCorrespondenceTrailReport","CorrespondenceTrail",new {area = "Cargo"}) %>'; 
     RequestForCorrespondenceTrailReportAllUrl = '<%:Url.Action("RequestForCorrespondenceTrailReportAll","CorrespondenceTrail",new {area = "Cargo"}) %>'; 
     ...
     /*CMP #596: Length of Member Accounting Code to be Increased to 12 
      ...
      Ref: FRS Section 3.4 Table 15 Row 30 */
...
<h1>Correspondence Reports</h1>
  ...
  <div class="buttonContainer" id="gridButtons1">
