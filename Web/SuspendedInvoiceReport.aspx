<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuspendedInvoiceReport.aspx.cs" Inherits="Iata.IS.Web.SuspendedInvoiceReport" %>
...
<head id="Head1" runat="server">
    <title>Suspended Invoice Report</title>
    <style type="text/css">
