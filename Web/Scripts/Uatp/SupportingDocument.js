...
function loadAttachment(invId) {
  ...
  $('#divAttachment').dialog({ closeOnEscape: false, title: 'Add/Remove Attachments', height: 450, width: 850, modal: true, resizable: false });
  fileIps = 1;
 ...
 //TFS#9965:Firefox: v47 :UATP:Manage Supporting document:Add Remove attachments:Pagination appears distorted
...
function resetSearchCriteria() {
  ...
  $("#IsMismatchCases").removeAttr('checked');
}