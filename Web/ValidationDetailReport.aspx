<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ValidationDetailReport.aspx.cs" Inherits="Iata.IS.Web.ValidationDetailReport" %>
...
<head id="Head1" runat="server">
    <title>IS Validation Details</title>
    <style type="text/css">
...
<body>
    ...
    <div>
    <CR:CrystalReportViewer ID="CRValidationDetail" runat="server" 
