<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OwSampling.aspx.cs" Inherits="Iata.IS.Web.OwSampling" %>
...
<head runat="server">
    <title>Passenger Sampling Billing Analysis</title>
    <style type="text/css">
        .crHeader
        {
...
<body>
    ...
    <div>
     <CR:CrystalReportViewer ID="PassengerSamplingBillingAnalysis" runat="server" 
