<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CorrespondenceReport.aspx.cs" Inherits="Iata.IS.Web.CorrespondenceReport" %>
...
<head id="Head1" runat="server">
    <title>Correspondence Status Report</title>
    <style type="text/css">
...
<body>
    ...
    <div>
    <CR:CrystalReportViewer ID="CRCorrespondenceReport" runat="server" 
